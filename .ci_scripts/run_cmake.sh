...
"vita")
	...
	;;
"switch")
	docker exec switchdev /bin/bash -c "git config --global --add safe.directory /build/git && /opt/devkitpro/portlibs/switch/bin/aarch64-none-elf-cmake -DCMAKE_BUILD_TYPE=Release -DEASYAV1_USE_EXTERNAL_DAV1D_LIBRARY=ON -DTARGET_PLATFORM=switch -B build -S ."
	;;
"mac")
