...
static const building_type MENU_BUILDING_TYPE[BUILD_MENU_MAX][BUILD_MENU_ITEM_MAX] = {
    ...
    {BUILDING_MENU_STATUES, BUILDING_MENU_TREES, BUILDING_MENU_PARKS, BUILDING_MENU_PATHS,BUILDING_MENU_GOV_RES, BUILDING_GARDENS, 
        BUILDING_PLAZA, BUILDING_ROADBLOCK, BUILDING_FORUM, BUILDING_GRAND_GARDEN, BUILDING_SENATE_UPGRADED, BUILDING_TRIUMPHAL_ARCH, 0},
    ...
    {BUILDING_MENU_FARMS, BUILDING_MENU_RAW_MATERIALS, BUILDING_MENU_WORKSHOPS,
        BUILDING_MARKET, BUILDING_GRANARY, BUILDING_WAREHOUSE, BUILDING_DISTRIBUTION_CENTER, 0},
    ...
    {BUILDING_COLONNADE, BUILDING_GARDEN_WALL, BUILDING_HEDGE_LIGHT, BUILDING_HEDGE_DARK, BUILDING_GARDEN_PATH, BUILDING_PAVILION_BLUE, BUILDING_SMALL_POND, BUILDING_LARGE_POND, 0},
    ...
    {BUILDING_SMALL_STATUE, BUILDING_SMALL_STATUE_ALT, BUILDING_SMALL_STATUE_ALT_B, BUILDING_DECORATIVE_COLUMN, BUILDING_MEDIUM_STATUE, BUILDING_OBELISK, BUILDING_LEGION_STATUE, BUILDING_DOLPHIN_FOUNTAIN, BUILDING_LARGE_STATUE, BUILDING_HORSE_STATUE, 0},
...
static void enable_normal(int *enabled, building_type type)
{
    ...
    enable_if_allowed(enabled, type, BUILDING_DISTRIBUTION_CENTER);
