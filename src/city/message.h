...
typedef enum {
    ...
    MESSAGE_SOLDIERS_STARVING = 122,
    MESSAGE_SOLDIERS_STARVING_NO_MESS_HALL = 123,
    MESSAGE_GRAND_TEMPLE_COMPLETE = 124,
    MESSAGE_BLESSING_FROM_MERCURY_ALTERNATE = 125,
    MESSAGE_AUTO_FESTIVAL_CERES = 126,
    MESSAGE_AUTO_FESTIVAL_NEPTUNE = 127,
    MESSAGE_AUTO_FESTIVAL_MERCURY = 128,
    MESSAGE_AUTO_FESTIVAL_MARS = 129,
    MESSAGE_AUTO_FESTIVAL_VENUS = 130,
    MESSAGE_PANTHEON_COMPLETE = 131,
    MESSAGE_LIGHTHOUSE_COMPLETE = 132,
    MESSAGE_BLESSING_FROM_NEPTUNE_ALTERNATE = 133,
    MESSAGE_BLESSING_FROM_VENUS_ALTERNATE = 134,
    MESSAGE_COLOSSEUM_COMPLETE = 135,
    MESSAGE_HIPPODROME_COMPLETE = 136,
    MESSAGE_COLOSSEUM_WORKING_NEW = 137,
    MESSAGE_HIPPODROME_WORKING_NEW = 138,
    MESSAGE_NG_GAMES_PLANNED = 139,
    MESSAGE_NG_GAMES_START = 140,
    MESSAGE_NG_GAMES_END = 141,
    MESSAGE_AN_GAMES_PLANNED = 142,
    MESSAGE_AN_GAMES_START = 143,
    MESSAGE_AN_GAMES_END = 144,
    MESSAGE_KI_GAMES_PLANNED = 145,
    MESSAGE_KI_GAMES_START = 146,
