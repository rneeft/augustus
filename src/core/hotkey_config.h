...
typedef enum {
    ...
    HOTKEY_BUILD_OVERGROWN_GARDENS,
    ...
    HOTKEY_SAVE_MINIMAP_SCREENSHOT,
    HOTKEY_BUILD_CLONE,
    HOTKEY_COPY_BUILDING_SETTINGS,
    HOTKEY_PASTE_BUILDING_SETTINGS,
    HOTKEY_UNDO,
    ...
    HOTKEY_SHOW_OVERLAY_RISKS_NATIVE,
    HOTKEY_BUILD_HIGHWAY,
    HOTKEY_SHOW_OVERLAY_ENEMY,
    HOTKEY_MAX_ITEMS
} hotkey_action;
