...
enum {
    ...
    FIGURE_ACTION_231_FARMER_SPAWNED = 231,
    FIGURE_ACTION_232_FARMER_GOING_TO_PLOT = 232,
    FIGURE_ACTION_233_FARMER_FARMING = 233,
    FIGURE_ACTION_234_FARMER_RETURNING_TO_FARMHOUSE = 234
};
