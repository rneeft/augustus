...
static translation_string all_strings[] = {
    ...
    {TR_OVERLAY_HOUSING, "Housing"},
    {TR_OVERLAY_HOUSING_SMALL_TENTS, "Small Tents"},
    {TR_OVERLAY_HOUSING_LARGE_TENTS, "Large Tents"},
    {TR_OVERLAY_HOUSING_SMALL_SHACKS, "Small Shacks"},
    {TR_OVERLAY_HOUSING_LARGE_SHACKS, "Large Shacks"},
    {TR_OVERLAY_HOUSING_SMALL_HOVELS, "Small Hovels"},
    {TR_OVERLAY_HOUSING_LARGE_HOVELS, "Large Hovels"},
    {TR_OVERLAY_HOUSING_SMALL_CASAS, "Small Casas"},
    {TR_OVERLAY_HOUSING_LARGE_CASAS, "Large Casas"},
    {TR_OVERLAY_HOUSING_SMALL_INSULAE, "Small Insulae"},
    {TR_OVERLAY_HOUSING_MEDIUM_INSULAE, "Medium Insulae"},
    {TR_OVERLAY_HOUSING_LARGE_INSULAE, "Large Insulae"},
    {TR_OVERLAY_HOUSING_GRAND_INSULAE, "Grand Insulae"},
    {TR_OVERLAY_HOUSING_SMALL_VILLAS, "Small Villas"},
    {TR_OVERLAY_HOUSING_MEDIUM_VILLAS, "Medium Villas"},
    {TR_OVERLAY_HOUSING_LARGE_VILLAS, "Large Villas"},
    {TR_OVERLAY_HOUSING_GRAND_VILLAS, "Grand Villas"},
    {TR_OVERLAY_HOUSING_SMALL_PALACES, "Small Palaces"},
    {TR_OVERLAY_HOUSING_MEDIUM_PALACES, "Medium Palaces"},
    {TR_OVERLAY_HOUSING_LARGE_PALACES, "Large Palaces"},
    {TR_OVERLAY_HOUSING_LUXURY_PALACES, "Luxury Palaces"},
};
