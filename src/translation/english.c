...
static translation_string all_strings[] = {
    ...
    {TR_ADVISOR_SICKNESS_LEVEL_MEDIUM, "Some infectious diseases have appeared in the city, but the situation is under control. Ensure a correct level of hygiene in order for trade to not be impacted. Hospitals are more effective at preventing epidemics than clinics."},
    ...
    {TR_ADVISOR_SICKNESS_LEVEL_PLAGUE, "The plague strikes the city and trade is severely impacted. Doctors and surgeons are requisitioned to decontaminate places being the most afflicted by the epidemic. The situation must absolutely be restored!"},
