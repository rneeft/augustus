...
static translation_string all_strings[] = {
    ...
    { TR_ADVISOR_TOURISM_DESCRIPTION_1, "Nonexistant" },
    { TR_ADVISOR_TOURISM_DESCRIPTION_2, "Obscure" },
    { TR_ADVISOR_TOURISM_DESCRIPTION_3, "Developing" },
    { TR_ADVISOR_TOURISM_DESCRIPTION_4, "Established" },
    { TR_ADVISOR_TOURISM_DESCRIPTION_5, "Fashionable" },
    { TR_ADVISOR_TOURISM_DESCRIPTION_6, "Excellent" },
    { TR_ADVISOR_TOURISM_DESCRIPTION_7, "Glorious" },
    { TR_ADVISOR_TOURISM_DESCRIPTION_8, "Legendary" },
    { TR_ADVISOR_TOURISM_DESCRIPTION_9, "Eternal" },
    { TR_ADVISOR_TOURISM_DESCRIPTION_TEXT, "Renown brings tourists to your city, to spend money and spread your fame." },
    { TR_ADVISOR_TOURISM_DESCRIPTION_TEXT_2, "The renown of your city is: " },
