...
static translation_string all_strings[] = {
    ...
    {TR_OVERLAY_HOUSING_SMALL_TENT, "Small Tents"},
    {TR_OVERLAY_HOUSING_LARGE_TENT, "Large Tents"},
    {TR_OVERLAY_HOUSING_SMALL_SHACK, "Small Shacks"},
    {TR_OVERLAY_HOUSING_LARGE_SHACK, "Large Shacks"},
    {TR_OVERLAY_HOUSING_SMALL_HOVEL, "Small Hovels"},
    {TR_OVERLAY_HOUSING_LARGE_HOVEL, "Large Hovels"},
    {TR_OVERLAY_HOUSING_SMALL_CASA, "Small Casas"},
    {TR_OVERLAY_HOUSING_LARGE_CASA, "Large Casas"},
    {TR_OVERLAY_HOUSING_SMALL_INSULA, "Small Insulae"},
    {TR_OVERLAY_HOUSING_MEDIUM_INSULA, "Medium Insulae"},
    {TR_OVERLAY_HOUSING_LARGE_INSULA, "Large Insulae"},
    {TR_OVERLAY_HOUSING_GRAND_INSULA, "Grand Insulae"},
    {TR_OVERLAY_HOUSING_SMALL_VILLA, "Small Villas"},
    {TR_OVERLAY_HOUSING_MEDIUM_VILLA, "Medium Villas"},
    {TR_OVERLAY_HOUSING_LARGE_VILLA, "Large Villas"},
    {TR_OVERLAY_HOUSING_GRAND_VILLA, "Grand Villas"},
    {TR_OVERLAY_HOUSING_SMALL_PALACE, "Small Palaces"},
    {TR_OVERLAY_HOUSING_MEDIUM_PALACE, "Medium Palaces"},
    {TR_OVERLAY_HOUSING_LARGE_PALACE, "Large Palaces"},
    {TR_OVERLAY_HOUSING_LUXURY_PALACE, "Luxury Palaces"},
};
