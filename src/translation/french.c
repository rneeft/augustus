...
static translation_string all_strings[] = {
    ...
    {TR_CONFIG_NOT_ACCEPTING_MARKETS, "Les marchés n'acceptent rien par défaut" },
    ...
    {TR_BUILDING_FORT_STANDARD_ELEPHANTS, "\"Les éléphants\""},
    {TR_BUILDING_FORT_STANDARD_THUNDER_BOLTS, "\"Les éclairs\""},
    ...
    {TR_CONFIG_MAX_AUTOSAVE_SLOTS, "Nombre d'emplacements pour les sauvegardes annuelles automatiques :" },
    ...
    {TR_CONFIG_CARAVANS_MOVE_OFF_ROAD, "Les caravanes ne suivent pas en priorité le réseau routier" },
    ...
    {TR_TOOLTIP_DEPOT_MOVED, "Déplace ressource :" },
    ...
    {TR_CONFIG_PATRICIAN_DEVOLUTION_FIX, "Les villas des patriciens gardent leur intégrité quand elles régressent" },
    {TR_CONDITION_TEXT_TIME_LEFT_UNTIL_DEFEAT, "Temps jusque défaite :" },
    {TR_CONDITION_TEXT_TIME_LEFT_UNTIL_VICTORY, "Temps jusque victoire :" },
    {TR_ACTION_TYPE_CHANGE_TERRAIN, "Ajouter/enlever terrain" },
    ...
    {TR_PARAMETER_TERRAIN_SHRUB, "Arbuste" },
    {TR_CHEAT_DISABLE_INVASIONS, "Désactiver invasions"},
};
