...
static translation_string all_strings[] = {
    ...
    {TR_SAVE_DIALOG_CUSTOM_SCENARIO, "Eigenes Szenario"},
    {TR_SAVE_DIALOG_FIRST_MISSION, "Erste Aufgabe"},
    {TR_SAVE_DIALOG_MISSION, "Aufgabe"},
    ...
    {TR_WINDOW_MESSAGE_LIST_SELECTED_ALL, "Alle Nachrichten"},
    {TR_WINDOW_MESSAGE_LIST_SELECTED_COMMON, "Allgemeine Nachrichten" },
    {TR_WINDOW_MESSAGE_LIST_SELECTED_CUSTOM, "Benutzerdefinierte Nachrichten" },
    {TR_SELECTED, "Ausgewählt"},
    {TR_SELECT_ALL, "Alle auswählen"},
    {TR_SELECT_NONE, "Keine Auswählen"},
	/* Asset Vorschau */
    ...
    {TR_CONFIG_AUDIO, "Audio Einstellungen"},
    ...
    {TR_CONFIG_DEFAULT_PLAYER_NAME, "Standard-Spielername:"},
    ...
    {TR_CONFIG_SHOW_WATER_STRUCTURE_RANGE_HOUSES, "Beim Bau eines Hauses die Reichweite von Brunnen anzeigen"},
	...
	/* Einstellungen - Benutzerverzeichnis*/
    {TR_CONFIG_USER_PATH_DEFAULT, "Standard (Caesar III Installationspfad, keine Unterverzeichnisse)" },
    {TR_CONFIG_USER_PATH_WITH_SUBDIRECTORIES, "Caesar III-Installationspfad, mit Unterverzeichnissen" },
    {TR_CONFIG_USER_PATH_RECOMMENDED, "Empfohlen ("},
    {TR_CONFIG_USER_PATH_CUSTOM, "Eigenes Verzeichnis festlegen..."},
    {TR_USER_DIRECTORIES_NOT_SET_UP_TITLE, "Eigene Benutzerverzeichnisse nicht eingerichtet"},
    {TR_USER_DIRECTORIES_NOT_SET_UP_TEXT, "Sie haben Ihr Benutzerverzeichnis, in dem die Spielstände, Szenarien und Karten gespeichert werden, nicht eingerichtet.\n" \
        "Möchten Sie das jetzt tun?"},
    {TR_USER_DIRECTORIES_CANCELLED_TITLE, "Verzeichnisauswahl abgebrochen"},
    {TR_USER_DIRECTORIES_CANCELLED_TEXT, "Sie haben sich entschieden, kein Benutzerverzeichnis festzulegen. Es wird das Caesar III-Installationsverzeichnis verwendet.\n"
        "Sie können Ihre Einstellungen später im Optionsmenü ändern."},
    {TR_USER_DIRECTORIES_NOT_WRITEABLE_TITLE, "Benutzerverzeichnis nicht überschreibbar."},
    ...
    {TR_HOTKEY_SHOW_OVERLAY_EMPLOYMENT, "Beschäftigungskarte" },
    ...
    {TR_HOTKEY_SHOW_OVERLAY_HEALTH, "Gesundheitskarte" },
    ...
    {TR_HOTKEY_SHOW_OVERLAY_LOGISTICS, "Logistik-Karte" },
    ...
    {TR_CHEAT_BUILDINGS_INVINCIBLE, "Gebaute Gebäude stürzen nicht ein"},
    {TR_CHEAT_CASTED_BLESSING, "Segen gesprochen"},
    {TR_CHEAT_CASTED_CURSE, "Einen Fluch wirken"},
    {TR_CHEAT_CLIMATE_CHANGE, "Der Klimawandel ist wirksam" },
    {TR_CHEAT_EDITOR_WARNING_TITLE, "Warnung"},
    {TR_CHEAT_EDITOR_WARNING_TEXT, "Das Ausführen des Karteneditors im Stadtmodus kann den Speicherstand beschädigen oder das Spiel zum Absturz bringen.\n\nStellen Sie sicher, dass Sie eine Sicherungskopie des aktuellen Spielstands haben."},
    ...
    {TR_OVERLAY_EMPLOYMENT, "Beschäftigung" },
    {TR_OVERLAY_ENEMY, "Feinde"},
    {TR_OVERLAY_HEALTH, "Gesamt"},
    {TR_OVERLAY_LEVY, "Abgaben"},
    {TR_OVERLAY_LOGISTICS, "Logistik" },
    ...
    {TR_WARNING_NO_ARMOURY, "Bauen Sie eine Waffenkammer, um Waffen an Kasernen zu liefern." },
    ...
    {TR_REPLAY_MAP_NOT_FOUND_TITLE, "Karte kann nicht wiederholt werden"},
    {TR_REPLAY_MAP_NOT_FOUND_MESSAGE, "Die ursprüngliche Kartendatei für dieses gespeicherte Spiel wurde nicht gefunden.\nSie benötigen die folgende Datei mit der Erweiterung .map oder .mapx:"},
    /* Asset-Warnung */
    ...
    {TR_CITY_MESSAGE_TEXT_CARAVANSERAI_COMPLETE, "Die Karawanserei ist nun fertiggestellt, und es werden sich mit Sicherheit neue Handelsmöglichkeiten ergeben. Karawanen aus der ganzen Welt kündigen bereits an, dass sie gerne in eure Stadt kommen und Handel treiben möchten."},
    ...
    {TR_WINDOW_ADVISOR_MILITARY_INFANTRY, "Infanteristen"},
    ...
    {TR_WINDOW_ADVISOR_LEGIONARIES, "Legionäre" },
    {TR_WINDOW_ADVISOR_JAVELIN, "Wurfspeere" },
    {TR_WINDOW_ADVISOR_MOUNTED, "Berittene" },
    {TR_WINDOW_ADVISOR_MILITARY_ARCHER, "Bogenschützen"},
	/* Berater - Wohnung*/
	...
	/* Berater - Gesundheit*/
    {TR_ADVISOR_HEALTH_RATING, "Wertung:"},
    {TR_ADVISOR_HEALTH_SURVEILLANCE, "Krankheitsüberwachung:"},
    ...
    {TR_TOOLTIP_BARRACKS_PRIORITY_FORT, "Priorisierte Ausbildung von Legionären"},
    {TR_TOOLTIP_BARRACKS_PRIORITY_JAVELIN, "Priorisierte Ausbildung von Wurfspeeren"},
    {TR_TOOLTIP_BARRACKS_PRIORITY_MOUNTED, "Priorisierte Ausbildung von Berittenen"},
    {TR_TOOLTIP_BARRACKS_PRIORITY_AUXINF, "Priorisierte Ausbildung von Infanteristen"},
    {TR_TOOLTIP_BARRACKS_PRIORITY_AUXARCH, "Priorisierte Ausbildung von Bogenschützen"},
    {TR_TOOLTIP_BARRACKS_PRIORITY_TOWER, "Priorisierte Ausbildung von Turmwächtern"},
    {TR_TOOLTIP_BARRACKS_PRIORITY_WATCHTOWER, "Priorisierte Ausbildung von Wachturm Wächtern"},
    {TR_TOOLTIP_BUTTON_ACCEPT_ARMOURY, "Waffenkammern Zugriff gewähren"},
    {TR_TOOLTIP_BUTTON_REJECT_ARMOURY, "Waffenkammern keinen Zugriff gewähren"},
    {TR_TOOLTIP_BUTTON_ACCEPT_BARKEEP, "Gastwirtinnen Zugriff gewähren"},
    {TR_TOOLTIP_BUTTON_REJECT_BARKEEP, "Gastwirtinnen keinen Zugriff gewähren"},
    {TR_TOOLTIP_BUTTON_ACCEPT_CARAVANSERAI, "Karawanserei Zugriff gewähren"},
    {TR_TOOLTIP_BUTTON_REJECT_CARAVANSERAI, "Karawanserei keinen Zugriff gewähren"},
    {TR_TOOLTIP_BUTTON_ACCEPT_DELIVERY, "Waffenlieferungen aus Waffenschmieden zulassen"},
    {TR_TOOLTIP_BUTTON_REJECT_DELIVERY, "Keine Waffenlieferungen aus Waffenschmieden zulassen"},
    {TR_TOOLTIP_BUTTON_ACCEPT_LIGHTHOUSE, "Leuchtturm Zugriff gewähren"},
    {TR_TOOLTIP_BUTTON_REJECT_LIGHTHOUSE, "Leuchtturm keinen Zugriff gewähren"},
    {TR_TOOLTIP_BUTTON_ACCEPT_MARKET_LADIES, "Erlaube Marktfrauen von hier Waren zu holen"},
    {TR_TOOLTIP_BUTTON_REJECT_MARKET_LADIES, "Marktfrauen keinen Zugriff gewähren"},
    {TR_TOOLTIP_BUTTON_ACCEPT_QUARTERMASTER, "Erlaube Quartiermeister von hier Nahrung zu holen"},
    {TR_TOOLTIP_BUTTON_REJECT_QUARTERMASTER, "Quartiermeistern keinen Zugriff gewähren"},
    {TR_TOOLTIP_BUTTON_ACCEPT_TRADE_CARAVAN, "Erlaube Karawanen hier Handel zu treiben"},
    {TR_TOOLTIP_BUTTON_REJECT_TRADE_CARAVAN, "Handelskarawanen keinen Zugriff gewähren"},
    {TR_TOOLTIP_BUTTON_ACCEPT_TRADE_SHIPS, "Erlaube Handelsschiffen hier Handel zu treiben"},
    {TR_TOOLTIP_BUTTON_REJECT_TRADE_SHIPS, "Handelsschiffen keinen Zugriff gewähren"},
    {TR_TOOLTIP_BUTTON_ACCEPT_WORKCAMP, "Arbeiterlager Zugriff gewähren"},
    {TR_TOOLTIP_BUTTON_REJECT_WORKCAMP, "Arbeiterlager keinen Zugriff gewähren"},
    {TR_TOOLTIP_BUTTON_ACCEPT_WORKERS, "Wiederaufnahme der Rohstofflieferungen an Werkstätten oder Silos"},
    {TR_TOOLTIP_BUTTON_REJECT_WORKERS, "Stopp der Rohstofflieferungen an Werkstätten oder Silos"},
    {TR_TOOLTIP_BUTTON_CAN_GO_TO_ADVISORS, "Den entsprechenden Berater für dieses Gebäude anzeigen." },
    {TR_TOOLTIP_BUTTON_CENTER_CAMERA, "Kamera auf Gebäude zentrieren"},
    {TR_TOOLTIP_BUTTON_DELETE_COMMON_MESSAGES, "Allgemeine Nachrichten löschen"},
    ...
    {TR_TOOLTIP_BUTTON_ROADBLOCK_PERMISSION, "Berechtigungen" },
    ...
    {TR_TOOLTIP_BUTTON_ROADBLOCK_ORDER_ACCEPT_ALL, "Alle Wanderer akzeptieren"},
    {TR_TOOLTIP_BUTTON_ROADBLOCK_ORDER_REJECT_ALL, "Alle Wanderer ablehnen"},
    ...
    {TR_TOOLTIP_BUTTON_STORAGE_ORDER_ACCEPT_ALL, "Alle Waren annehmen"},
    {TR_TOOLTIP_BUTTON_STORAGE_ORDER_REJECT_ALL, "Alle Waren ablehnen"},
    {TR_TOOLTIP_BUTTON_DELETE_COMMON_MESSAGES, "Allgemeine Nachrichten löschen"},
    ...
    {TR_TOOLTIP_OVERLAY_EMPLOYMENT_FULL, "Dieses Gebäude ist voll besetzt." },
    {TR_TOOLTIP_OVERLAY_EMPLOYMENT_MISSING_1, " Arbeiter in diesem Gebäude benötigt." },
    {TR_TOOLTIP_OVERLAY_EMPLOYMENT_MISSING_2, " Arbeiter in diesem Gebäude benötigt." },
    {TR_TOOLTIP_OVERLAY_EMPLOYMENT_MOTHBALL, " Arbeiter in diesem Gebäude benötigt. (eingemottet)" },
    {TR_TOOLTIP_OVERLAY_HEALTH_NONE, "Hier lebt noch kein Bürger."},
    {TR_TOOLTIP_OVERLAY_HEALTH_0, "Die Gesundheit in diesem Haus ist katastrophal."},
    {TR_TOOLTIP_OVERLAY_HEALTH_1, "Die Gesundheit in diesem Haus ist schrecklich."},
    {TR_TOOLTIP_OVERLAY_HEALTH_2, "Die Gesundheit in diesem Haus ist schlimm."},
    {TR_TOOLTIP_OVERLAY_HEALTH_3, "Die Gesundheit in diesem Haus ist schlecht."},
    {TR_TOOLTIP_OVERLAY_HEALTH_4, "Die Gesundheit in diesem Haus ist unterdurchschnittlich."},
    {TR_TOOLTIP_OVERLAY_HEALTH_5, "Die Gesundheit in diesem Haus ist durchschnittlich."},
    {TR_TOOLTIP_OVERLAY_HEALTH_6, "Die Gesundheit in diesem Haus ist gut."},
    {TR_TOOLTIP_OVERLAY_HEALTH_7, "Die Gesundheit in diesem Haus ist sehr gut."},
    {TR_TOOLTIP_OVERLAY_HEALTH_8, "Die Gesundheit in diesem Haus ist exzellent."},
    {TR_TOOLTIP_OVERLAY_HEALTH_9, "Die Gesundheit in diesem Haus ist fast perfekt."},
    {TR_TOOLTIP_OVERLAY_HEALTH_10, "Die Gesundheit in diesem Haus ist perfekt."},
    ...
    {TR_CARAVANSERAI_SPECIAL_ORDERS_HEADER, "Anweisungen für Karawanserei"}, //vielleicht zu lang
    ...
    {TR_BUILDING_AMPHITHEATER_DESC_UPGRADED_BOTH_SHOWS, "Dieses Amphitheater bietet seiner Umgebung sowohl aufregende Gladiatorenkämpfe als auch Theateraufführungen. Die örtliche Entwicklung ermöglichte es Ihren Bürgern, das Gebäude zu erweitern und mehr Sitzplätze zu schaffen."},
    {TR_BUILDING_AMPHITHEATER_DESC_UPGRADED_NO_GLADIATORS, "In diesem Amphitheater werden Theaterstücke aufgeführt. Es würde den Zuschauern besser gefallen, wenn es Gladiatoren hätte, um reale Kämpfe zu zeigen. Die lokale Entwicklung hat es Ihren Bürgern ermöglicht, das Gebäude zu erweitern, aber Gladiatoren würden dafür sorgen, dass die zusätzlichen Sitzplätze voll bleiben." },
    {TR_BUILDING_AMPHITHEATER_DESC_UPGRADED_NO_ACTORS, "In diesem Amphitheater finden Gladiatorenkämpfe zur Unterhaltung der umliegenden Bevölkerung statt, aber zwischen den dramatischen Kämpfen fehlt es an belustigenden Aufführungen. Die örtliche Entwicklung hat es Ihren Bürgern ermöglicht, das Gebäude zu erweitern, aber die Schauspieler würden dafür sorgen, dass die zusätzlichen Sitzplätze voll bleiben." },
    {TR_BUILDING_AMPHITHEATER_DESC_UPGRADED_NO_SHOWS, "In diesem Amphitheater finden nie Vorstellungen statt. Es braucht Schauspieler und Gladiatoren, um es zu unterhalten. Die lokale Entwicklung hat es Ihren Bürgern ermöglicht, das Gebäude zu erweitern, aber ohne Aufführungen bleiben die zusätzlichen Sitzplätze leer." },
    ...
    {TR_BUILDING_ARENA_DESC_UPGRADED_BOTH_SHOWS, "In dieser Arena werden zur Freude der Zuschauer Gladiatorenkämpfe und Tierhetzen veranstaltet. Die örtliche Entwicklung ermöglichte es Ihren Bürgern, das Gebäude zu erweitern und mehr Sitzplätze für die Aufführungen zu schaffen." },
    {TR_BUILDING_ARENA_DESC_UPGRADED_NO_GLADIATORS, "Diese Arena wird von hungrigen Bestien auf der Suche nach Beute durchstreift, aber der Mangel an ausgebildeten Gladiatoren sorgt für kurze Vorstellungen. Die lokale Entwicklung ermöglichte es Ihren Bürgern, das Gebäude zu erweitern, aber Gladiatoren würden dafür sorgen, dass die zusätzlichen Sitzplätze voll bleiben." },
    {TR_BUILDING_ARENA_DESC_UPGRADED_NO_LIONS, "In dieser Arena finden regelmäßig Gladiatorenkämpfe statt, um die Menge zu unterhalten, aber Löwenkämpfe würden das Spektakel aufwerten. Die lokale Entwicklung ermöglichte es Ihren Bürgern, das Gebäude zu erweitern, aber die Löwen würden dafür sorgen, dass die zusätzlichen Sitzplätze voll bleiben." },
    {TR_BUILDING_ARENA_DESC_UPGRADED_NO_SHOWS, "Diese Arena zeigt weder Löwen noch Gladiatoren und bietet wenig Unterhaltung. Die örtliche Entwicklung ermöglichte es Ihren Bürgern, das Gebäude zu erweitern, aber ohne Shows bleiben die zusätzlichen Sitzplätze leer." },
    ...
    {TR_BUILDING_FORT_ARCHERS, "Hilfstruppen - Bogenschützen"},
    {TR_BUILDING_FORT_AUXILIA_INFANTRY, "Hilfstruppen - Infanterie"},
    /* Gebäude - Goldmine */
	...
	/* Gebäude - Karawanserei */
    {TR_BUILDING_CARAVANSERAI, "Karawanserei"},
    ...
    {TR_BUILDING_NYMPHAEUM_PHASE_2, "(Fassade)" },
    {TR_BUILDING_NYMPHAEUM_PHASE_1_TEXT, "Die Steinmetze arbeiten an den Wänden und Säulen der Cella, dem Innenraum des Tempels, der die Ikonen der Nymphen und ihre heiligen Wasser beherbergen wird." },
    {TR_BUILDING_NYMPHAEUM_PHASE_2_TEXT, "Geschickte Handwerker bereiten die Fassade dieses Tempels vor, schnitzen glänzende Marmorstatuen in den Bildern der Wassernymphen und schmücken die Wände mit Muscheln und Mosaiken des Wassers." },
    ...
    {TR_BUILDING_SMALL_MAUSOLEUM_PHASE_1, "(Gewölbe)" },
    {TR_BUILDING_SMALL_MAUSOLEUM_PHASE_2, "(Fassade)" },
    {TR_BUILDING_SMALL_MAUSOLEUM_PHASE_1_TEXT, "Steinmetze verlegen Schichten aus präzise gearbeiteten Steinen, um das zentrale Gewölbe dieses Mausoleums zu bilden." },
    {TR_BUILDING_SMALL_MAUSOLEUM_PHASE_2_TEXT, "Geschickte Handwerker bereiten die Fassade dieses Mausoleums vor und meißeln glänzende Marmorstatuen zum Gedenken an diejenigen, die hier ruhen werden." },
    ...
    {TR_BUILDING_BOTH_MAUSOLEUM_DESC, "Dieses Mausoleum erfreut alle Götter, obwohl es für die umliegenden Häuser nicht attraktiv ist. Solche Grabstätten verbessern die sanitären Bedingungen in der Stadt und erhöhen die allgemeine Gesundheit der Bürger." },
    /* Gebäude - Leuchtturm */
    ...
    {TR_BUILDING_CITY_MINT_PHASE_1_TEXT, "Maurer legen das Mauerwerk für ein großes Gebäude, in dem Edelmetalle eingeschmolzen und zu Münzen geprägt werden sollen." },
    {TR_BUILDING_CITY_MINT_PHASE_2_TEXT, "Handwerker legen letzte Hand an die „Moneta“, den Ort, an dem die Münzen geprägt werden sollen, und errichten Gebäude für die Lagerung der ungeprägten Denare und Unterkünfte für die Münzpräger."},
    ...
    {TR_BUILDING_GRAND_TEMPLE_CERES_MODULE_1_DESC, "Priester der Ceres reduzieren Nahrungsverbrauch um 20 % in Häusern mit Zugang."},
    {TR_BUILDING_GRAND_TEMPLE_CERES_MODULE_2_DESC, "Priester der Ceres sammeln und verteilen sowohl Öl als auch ein Nahrungsmittel aus dem Lager."},
    {TR_BUILDING_GRAND_TEMPLE_NEPTUNE, "Neptuns Prachttempel"},
    {TR_BUILDING_GRAND_TEMPLE_NEPTUNE_DESC, "Prachttempel des Neptun"},
    {TR_BUILDING_GRAND_TEMPLE_NEPTUNE_BONUS_DESC, "Neptun erhöht die Reichweite von Brunnen und Ziehbrunnen um +1 sowie +2 für Reservoirs. Die Arbeitskraft für die Wasserversorgung wird um 50 % reduziert und Handelsschiffe fahren 25 % schneller. Der Anstieg von Krankheiten in Häusern wird stark eingeschränkt."},
    ...
    {TR_BUILDING_GRAND_TEMPLE_NEPTUNE_MODULE_2_DESC, "Priester des Neptun erhöhen das Bevölkerungslimit um 5 % für Häuser mit Zugang. Der Prachttempel dient als gefülltes Reservoir."},
    ...
    {TR_BUILDING_GRAND_TEMPLE_MERCURY_BONUS_DESC, "Merkur segnet Handelschiffe und Karawanen mit einer um 50 % höheren Kapazität und inspiriert Karawanen, sich 25 % schneller zu bewegen."},
    ...
    {TR_BUILDING_GRAND_TEMPLE_MERCURY_MODULE_1_DESC, "Priester des Merkur reduzieren Geschirr- und Möbelverbrauch um 20 % in Häusern mit Zugang."},
    {TR_BUILDING_GRAND_TEMPLE_MERCURY_MODULE_2_DESC, "Priester des Merkur reduzieren Öl- und Weinkonsum um 20 % in Häusern mit Zugang."},
    ...
    {TR_BUILDING_GRAND_TEMPLE_MARS_MODULE_1_DESC, "Priester des Mars erzeugen Nahrung, in einer Menge, die sich nach der Anzahl der abgedeckten Häuser richtet, und liefern sie an den Versorgungsposten. Gebäudekosten von Forts werden um 25 % reduziert."},
    {TR_BUILDING_GRAND_TEMPLE_MARS_MODULE_2_DESC, "Priester des Mars reduzieren den Verbrauch aller Waren um 10 % in Häusern mit Zugang."},
    ...
    {TR_BUILDING_GRAND_TEMPLE_VENUS_MODULE_1_DESC, "Der Prachttempel produziert Wein im Verhältnis zur Bevölkerung mit Zugang zu Tempeln der Venus. Priester verteilen ihn an die Häuser und Tavernen."},
    {TR_BUILDING_GRAND_TEMPLE_VENUS_MODULE_2_DESC, "Priester der Vernus bieten Unterhaltung und verschönern Häuser, dies steigert die Attraktivität der Nachbarschaft."},
    ...
    {TR_BUILDING_MARS_TEMPLE_MODULE_DESC_NO_MESS, "Dieser Tempel wird Essen für deinen Versorgungsposten produzieren, sobald er gebaut wurde."},
    {TR_BUILDING_MARS_TEMPLE_QUOTE, "Andere schufen für Mars ein Fahrzeug mit fliegenden\nRädern, wie er es braucht, um Menschen und Städte\naufs Schlachtfeld zu hetzen.\n-Virgil, die Aeneis; achter Gesang"},
    {TR_BUILDING_MERCURY_TEMPLE_QUOTE, "Beutet man doch im Kriege gemästete Rinder und Schafe,\nUnd gewinnt Dreifüß' und braungemähnete Rosse;\nAber des Menschen Geist kehrt niemals, weder erbeutet,\n noch erlangt, nachdem er des Sterbenden Lippen\nentflohn ist.\n-Homer, Die Ilias; 9. Gesang"},
    {TR_BUILDING_NEPTUNE_TEMPLE_QUOTE, "Nicht bleibt zürnend die See. Hinlegend die zackige\nWaffe glättet die Flut der Beherrscher des Meers,\nUnd den bläulichen Triton rufet er, dan der Schulter\nbedeckt von haftenden Schnecken über der Tiefe sich\nhebt und heißt in die tönende Muschel.\n-Ovid, die Metamorphose; Deukalion und Pyrrha"},
    ...
    {TR_BUILDING_TAVERN_DESC_UPGRADED_WINE_NO_FOOD, "Diese Taverne unterhält Ihre Bürger, solange der Wein fließt. Ein Angebot an Fleisch oder Fisch würde ihre Attraktivität erhöhen. Die örtliche Entwicklung hat es Ihren Bürgern ermöglicht, das Gebäude zu erweitern und mehr Platz für Gäste zu schaffen." },
    {TR_BUILDING_TAVERN_DESC_UPGRADED_WINE_AND_FOOD, "In dieser Taverne gibt es reichlich Wein und der Geruch von gebratenem Fleisch lädt zu Glücksspiel, Musik und Fröhlichkeit ein. Die örtliche Entwicklung hat es Ihren Bürgern ermöglicht, das Gebäude zu erweitern und mehr Platz für Gäste zu schaffen." },
    ...
    {TR_BUILDING_LARGE_TEMPLE_PHASE_2, "(Fassade)"},
    {TR_BUILDING_LARGE_TEMPLE_PHASE_1_TEXT, "Die Steinmetze arbeiten an den Wänden und Säulen der Cella, dem Innenraum des Tempels, der das heilige Bildnis beherbergen wird."},
    {TR_BUILDING_LARGE_TEMPLE_PHASE_2_TEXT, "Geschickte Handwerker bereiten die Fassade dieses Tempels vor und schnitzen glänzende Marmorstatuen nach dem Vorbild der Gottheit, die hier verehrt werden soll." },
    {TR_BUILDING_ORACLE_DESC, "Dieses prächtige Gebäude ist allen Göttern gewidmet, von den niedrigsten lokalen Geistern bis hin zu Jupiter selbst. Ein solch frommer Ort wird Ihrer Stadt sicher die Gunst der Göttlichen einbringen." },
    {TR_BUILDING_ORACLE_PHASE_1, "(Cella)" },
    {TR_BUILDING_ORACLE_PHASE_2, "(Fassade)" },
    {TR_BUILDING_ORACLE_PHASE_1_TEXT, "Die Steinmetze arbeiten an den Wänden und Säulen der Cella, dem Innenraum des Orakels, in dem die heiligen Bilder untergebracht werden." },
    {TR_BUILDING_ORACLE_PHASE_2_TEXT, "Geschickte Handwerker bereiten die Fassade dieses Orakels vor und meißeln glänzende Marmorstatuen in die Bilder der vielen Götter, die hier verehrt werden sollen." },
    ...
    {TR_BUILDING_MESS_HALL_NO_EMPLOYEES, "Dieser Versorgungsposten hat keine Mitarbeiter. Lebensmittel können nicht abgeholt werden." },
    ...
    {TR_BUILDING_ARMOURY_SOME_EMPLOYEES, "Da die Waffenkammer nur teilweise besetzt ist, wird die vollständige Ausrüstung der Legionen viel Zeit in Anspruch nehmen. Hoffentlich lassen sich unsere Feinde auch Zeit!"},
    {TR_BUILDING_ARMOURY_MANY_EMPLOYEES, "Die Waffenkammer ist in der Lage, die Soldaten mit Waffen zu versorgen, aber aufgrund des Mangels an Mitarbeitern kommt es gelegentlich zu Engpässen."},
    /* Gebäude - Ziegelei */
    ...
    {TR_WINDOW_BARRACKS_PRIORITY, "Priorität der Rekrutierung:"},
    {TR_WINDOW_BARRACKS_FORTS, "Forts"},
    {TR_WINDOW_BARRACKS_TOWERS, "Türme"},
    /* Neue Figuren_Typen */
    {TR_FIGURE_ENEMY_CATAPULT, "Katapult"},
    {TR_FIGURE_TYPE_ARMORY_CARTPUSHER, "Waffenlieferant"},
    {TR_FIGURE_TYPE_BARKEEP, "Gastwirtin"},
    {TR_FIGURE_TYPE_BARKEEP_SUPPLIER, "Tavernen-Lieferant"},
    {TR_FIGURE_TYPE_BEGGAR, "Bettler"},
    {TR_FIGURE_TYPE_CARAVANSERAI_COLLECTOR, "Karawanserei Laufbursche"},
    {TR_FIGURE_TYPE_CARAVANSERAI_SUPPLIER, "Karawanserei-Lieferant"},
    ...
    {TR_WINDOW_CAMPAIGN_FINISHED, "Kampagne abgeschlossen"},
    {TR_WINDOW_MISSION_LIST_CAMPAIGN_NOT_FINISHED, "Kampagne nicht abgeschlossen"},
    ...
    {TR_ACTION_TYPE_CAUSE_BLESSING, "Verursache einen Segen" },
    {TR_ACTION_TYPE_CAUSE_MINOR_CURSE, "Verursache einen leichten Fluch" },
    {TR_ACTION_TYPE_CAUSE_MAJOR_CURSE, "Verursache einen schweren Fluch" },
    ...
    {TR_ACTION_TYPE_CHANGE_CLIMATE, "Klima ändern" },
    ...
    {TR_CONDITION_TYPE_RESOURCE_STORED_COUNT, "Anzahl gelagerter Ressource"},
    ...
    {TR_EDITOR_CUSTOM_VARIABLE_UNABLE_TO_CHANGE_TITLE, "Benutzerdefinierte Variable nicht änderbar"},
    {TR_EDITOR_CUSTOM_VARIABLE_UNABLE_TO_CHANGE_TEXT, "Die benutzerdefinierte Variable wird von mindestens einem Ereignis verwendet.\n\nEntfernen Sie die benutzerdefinierte Variable aus dem Ereignis, um ihren Namen ändern oder sie löschen zu können."},
    {TR_EDITOR_CUSTOM_VARIABLE_UNABLE_TO_CHANGE_EVENT_ID, "Früheste Ereignis-ID, bei der die Variable verwendet wird: "},
    {TR_EDITOR_CUSTOM_VARIABLES_COUNT, "Gesamte Variablen:"},
    {TR_EDITOR_CUSTOM_VARIABLES_ID, "ID"},
    {TR_EDITOR_CUSTOM_VARIABLES_NAME, "Name"},
    {TR_EDITOR_CUSTOM_VARIABLES_VALUE, "Anfangswert"},
    {TR_EDITOR_CUSTOM_VARIABLES_NEW, "Neue eigene Variable"},
    {TR_EDITOR_CUSTOM_VARIABLE_UNABLE_TO_SET_NAME_TITLE, "Eigener Variablenname kann nicht festgelegt werden"},
    {TR_EDITOR_CUSTOM_VARIABLE_UNABLE_TO_SET_NAME_TEXT, "Der Name ist leer oder wird bereits von einer anderen benutzerdefinierten Variable verwendet.\n\nBitte benennen Sie die Variable um."},
    {TR_EDITOR_CUSTOM_VARIABLES_IN_USE, "Verwendete eigene Variablen: "},
    {TR_EDITOR_DELETE, "Löschen"},
    {TR_EDITOR_DELETED, "Gelöscht"},
    {TR_EDITOR_FAVOUR_DISFAVOR, "Gunstverlust bei Verlängerung" },
    {TR_EDITOR_FAVOUR_EXTENSION_MONTHS, "Erlaubte Verlängerungsmonate" },
    {TR_EDITOR_FAVOUR_IGNORED, "Gunstverlust bei Ignorierung" },
    ...
    {TR_EDITOR_RETURN_TO_CITY, "Zurück zur Stadt"},
    ...
    {TR_EDITOR_SCENARIO_DESELECT_INTRO, "Szenario-Intro entfernen"},
    ...
    {TR_EDITOR_SCENARIO_SELECT_VICTORY, "Siegesmeldung auswählen"},
    {TR_EDITOR_SCENARIO_EVENTS_NO_GROUP, "Keine Gruppe"},
    {TR_EDITOR_SCENARIO_EVENTS_GROUP, "Gruppe "},
    {TR_EDITOR_SCENARIO_EVENTS_NEW_GROUP, "Neue Gruppe"},
    {TR_EDITOR_SCENARIO_EVENTS_DELETE_SELECTED, "Lösche ausgewählte"},
    {TR_EDITOR_SCENARIO_EVENTS_GROUPS_EXPLANATION_TOOLTIP, "Wenn eine Bedingung in einer Gruppe erfüllt ist, gilt die Gruppe als erfüllt.\nDamit das Ereignis ausgelöst wird, müssen alle Gruppen sowie alle nicht gruppierten Bedingungen erfüllt sein."},
    {TR_EDITOR_SCENARIO_EVENTS_DELETE_SELECTED_CONFIRM_TITLE, "Ausgewählte löschen?"},
    {TR_EDITOR_SCENARIO_EVENTS_DELETE_SELECTED_CONFIRM_TEXT, "Sind Sie sicher, dass Sie die ausgewählten Elemente löschen möchten?\n\nDie Aktion ist unumkehrbar." },
    {TR_EDITOR_SCENARIO_EVENT_NAME, "Name: "},
    {TR_EDITOR_SCENARIO_NO_CONDITIONS, "Keine Bedingungen"},
    {TR_EDITOR_SCENARIO_NO_ACTIONS, "Keine Aktionen"},
    ...
    {TR_EDITOR_BETWEEN, "zwischen" },
    {TR_EDITOR_AND, "und" },
    {TR_EDITOR_UNITS, "Einheiten" },
    {TR_EDITOR_REQUEST, "Forderung"},
    {TR_EDITOR_REQUESTS, "Forderungen"},
    {TR_EDITOR_REQUEST_DATE, "Forderungsdatum:"},
    {TR_EDITOR_REQUEST_RESOURCE, "Ressource:"},
    {TR_EDITOR_REQUEST_AMOUNT, "Menge:"},
    {TR_EDITOR_REQUEST_DEADLINE, "Frist:"},
    {TR_EDITOR_REQUEST_FAVOR_GAINED, "Gunst-Gewinn:"},
    {TR_EDITOR_NEW_REQUEST, "Neue Forderung"},
    {TR_EDITOR_INVASION, "Invasion"},
    {TR_EDITOR_INVASIONS, "Invasionen"},
    {TR_EDITOR_NEW_INVASION, "Neue Invasion"},
    {TR_EDITOR_INVASION_DATE, "Invasions-Datum:"},
    {TR_EDITOR_INVASION_SIZE, "Invasions-Größe:"},
    {TR_EDITOR_INVASION_ENEMY_TYPE, "Feind-Typ:"},
    {TR_EDITOR_INVASION_FROM, "von:"},
    {TR_EDITOR_INVASION_ATTACK_PRIORITY, "Angriffspriorität:"},
    {TR_EDITOR_NEW_DEMAND_CHANGE, "Neue Änderung der Nachfrage"},
    {TR_EDITOR_NO_DEMAND_CHANGES, "Keine Änderung der Nachfrage"},
    {TR_EDITOR_NO_ROUTES, "(Keine Handelsroute)"},
    {TR_EDITOR_UNKNOWN_ROUTE, "(Unbekannte Route)"},
    {TR_EDITOR_SET_A_ROUTE, "(Route festlegen)"},
    {TR_EDITOR_NO_PRICE_CHANGES, "Keine Preisänderung"},
    {TR_EDITOR_NEW_PRICE_CHANGE, "Neue Preisänderung"},
    {TR_EDITOR_FORM_ERRORS_FOUND, "Fehler im Formular gefunden"},
    {TR_EDITOR_FORM_HAS_FOLLOWING_ERRORS, "Das Formular hat folgende Fehler:"},
    {TR_EDITOR_EDIT_REQUEST_NO_RESOURCE, "Keine Ressource gesetzt"},
    {TR_EDITOR_EDIT_REQUEST_NO_AMOUNT, "Keine Menge gesetzt"},
    ...
    {TR_EDITOR_ALLOWED_BUILDINGS_NOT_ALLOWED, "Nicht erlaubt"},
    {TR_EDITOR_REPEAT, "Wiederholung:"},
    {TR_EDITOR_DO_NOT_REPEAT, "Nicht wiederholen"},
    {TR_EDITOR_REPEAT_FOREVER, "unendlich wiederholen"},
    {TR_EDITOR_REPEAT_ONCE, "ein Mal wiederholen"},
    {TR_EDITOR_REPEAT_TWICE, "zwei Mal wiederholen"},
    {TR_EDITOR_REPEAT_TEXT, "Wiederholung"},
    {TR_EDITOR_REPEAT_TIMES, " Mal"},
    {TR_EDITOR_REPEAT_TIMES2, "Male:"},
    {TR_EDITOR_REPEAT_FREQUENCY, "Wiederholungsrate zwischen:"},
    {TR_EDITOR_REPEAT_FREQUENCY2, "Wiederholungsrate"},
    ...
    {TR_PARAMETER_TYPE_CLIMATE, "Klima" },
    {TR_PARAMETER_TYPE_CUSTOM_MESSAGE, "Benutzerdefinierte Nachricht"},
    {TR_PARAMETER_TYPE_CUSTOM_VARIABLE, "Benutzerdefinierte Variable"},
    {TR_PARAMETER_TYPE_DIFFICULTY, "Schwierigkeitsgrad"},
    {TR_PARAMETER_TYPE_ENEMY_TYPE, "Art des Feindes"},
    {TR_PARAMETER_TYPE_FUTURE_CITY, "Zukünftige Handelsstadt als Ziel"},
    {TR_PARAMETER_TYPE_GOD, "Gottheit" },
    {TR_PARAMETER_TYPE_INVASION_POINT, "Invasionspunkt"},
    {TR_PARAMETER_TYPE_INVASION_SIZE, "Größe"},
    {TR_PARAMETER_TYPE_INVASION_TYPE, "Angriffsart"},
    ...
    {TR_PARAMETER_TYPE_RATING_TYPE, "Bewertungstyp"},
    {TR_PARAMETER_TYPE_RESOURCE, "Ressource"},
    {TR_PARAMETER_TYPE_REQUEST, "Forderung" },
    {TR_PARAMETER_TYPE_ROUTE, "Zielhandelsroute"},
    {TR_PARAMETER_TYPE_STANDARD_MESSAGE, "Standardnachricht"},
    {TR_PARAMETER_TYPE_STORAGE_TYPE, "Art der Lagerung"},
    {TR_PARAMETER_TYPE_TARGET_TYPE, "Angriffsziel"},
    ...
    {TR_PARAMETER_VALUE_CLIMATE_CENTRAL, "Zentral" },
    {TR_PARAMETER_VALUE_CLIMATE_NORTHERN, "Nördlich" },
    {TR_PARAMETER_VALUE_CLIMATE_DESERT, "Wüste" },
    ...
    {TR_PARAMETER_VALUE_GOD_MERCURY, "Merkur"},
    ...
    {TR_PARAMETER_VALUE_MEDIA_TYPE_BACKGROUND_IMAGE, "Hintergrundbild"},
    {TR_PARAMETER_VALUE_MEDIA_TYPE_SOUND, "Ton"},
    {TR_PARAMETER_VALUE_MEDIA_TYPE_SPEECH, "Ansprache"},
    ...
    {TR_TOOLTIP_BUTTON_ACCEPT_NATIVES, "Erlaube Eingeborenen Händler"},
    {TR_TOOLTIP_BUTTON_REJECT_NATIVES, "Verbiete Eingeborenen Händler"},
    {TR_TOOLTIP_BUTTON_ACCEPT_ALL, "Erlaube alle"},
    {TR_TOOLTIP_BUTTON_REJECT_ALL, "Verbiete alle"},
    {TR_TOOLTIP_OVERLAY_PROBLEMS_NO_ROAD_ACCESS, "Keinen Straßenzugang"},
    {TR_WARNING_NO_WAREHOUSE_TOWER_ROAD_ACCESS, "Verbinden Sie eine Straßen mit dem Turm des Lagerhauses"},
    {TR_BUILDING_FORT_MENU, "Fort"},
    {TR_PARAMETER_VALUE_BUILDING_MENU_FORTS, "Alle Forts"},
    {TR_EMPIRE_SIDE_BAR_SORT, "Sortiere nach:"},
    {TR_EMPIRE_SIDE_BAR_FILTER, "Filtere nach:"},
    {TR_EMPIRE_SIDE_BAR_SORT_BY_NAME, "Name"},
    {TR_EMPIRE_SIDE_BAR_SORT_BY_QUOTA_FILL_EXPORT, "Export Rate"},
    {TR_EMPIRE_SIDE_BAR_SORT_BY_QUOTA_FILL_IMPORT, "Import Rate"},
    {TR_EMPIRE_SIDE_BAR_SORT_BY_ROUTE_COST, "Öffnungs Kosten"},
    {TR_EMPIRE_SIDE_BAR_SORT_BY_PROFIT, "Profit"},
    {TR_EMPIRE_SIDE_BAR_FILTER_BY_RESOURCE, "Ressource"},
    {TR_EMPIRE_SIDE_BAR_FILTER_BY_OPEN, "Offene Routen"},
    {TR_EMPIRE_SIDE_BAR_FILTER_BY_CLOSED, "Geschlossene Routen"},
    {TR_EMPIRE_SIDE_BAR_FILTER_BY_LAND, "Land Routen"},
    {TR_EMPIRE_SIDE_BAR_FILTER_BY_SEA, "Meer Routen"},
    {TR_EMPIRE_SIDE_BAR_FILTER_BY_NONE, "Kein Filter"},
    {TR_TOOLTIP_CHANGE_SIDEBAR_WIDTH, "Verändere Länge der Seitenleiste"},
    {TR_TOOLTIP_ASCENDING_ORDER, "Aufsteigende Ortnung"},
    {TR_TOOLTIP_DESCENDING_ORDER, "Absteigende Ortnung"},
    {TR_CONFIG_DEFAULT_GAME_SPEED, "Standart Spielgeschwindigkeit:"},
    {TR_CONFIG_CATEGORY_GENERAL, "Generell"},
    {TR_CONFIG_CATEGORY_UI_MAP, "Scrollen und Karte"},
    {TR_CONFIG_CATEGORY_UI_BUILDING, "Bauen"},
    {TR_CONFIG_CATEGORY_UI_CITY, "Stadtansicht"},
    {TR_CONFIG_CATEGORY_UI_WEATHER, "Wetter"},
