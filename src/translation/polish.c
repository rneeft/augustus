...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_AMPHITHEATER_DESC_UPGRADED_BOTH_SHOWS, "Ten amfiteatar oferuje swojej społeczności zarówno ekscytujące pojedynki gladiatorów, jak i sztuki wystawiane przez lokalnych aktorów. Tutejszy rozwój pozwolił mieszkańcom powiększyć budynek, zwiększając jego pojemność, a widownia pozostaje wypełniona po brzegi."},
    {TR_BUILDING_AMPHITHEATER_DESC_UPGRADED_NO_ACTORS, "Ten amfiteatar oferuje swojej społeczności ekscytujące pojedynki gladiatorów, lecz brak mu sztuk które wystawiane byłyby pomiędzy walkami. Tutejszy rozwój pozwolił mieszkańcom powiększyć budynek, choć nabór aktorów pozoliłby upewnić się, że widownia pozostaje wypełniona po brzegi."},
    ...
    {TR_BUILDING_ARMOURY_MANY_EMPLOYEES, "Zbrojownia jest w stanie zapewnić dostawy broni do naszych baraków, lecz braki w zatrudnieniu powodują okazjonalne deficyty."},
    ...
    {TR_BUILDING_CARAVANSERAI_FOOD_SHORTAGE, "Caravanserai ma pracowników i jedzenie, lecz poziom zapasów jest zbyt niski by wykarmić wszystkie kupieckie karawany."},
    {TR_BUILDING_CARAVANSERAI_NO_EMPLOYEES, "Caravanserai nie ma pracowników. Nikt nie dostarcza zapasów."},
    ...
    {TR_BUILDING_LARGE_TEMPLE_PHASE_2_TEXT, "Umiejętni rzemieślnicy przygotowywują fasdę tej świątyni, przekłuwając lśniący marmur w oblicza bóstwa które będzie tu wielbione."},
    ...
    {TR_BUILDING_LATRINES_UNNECESSARY, "Te latryny pełnią tu żadnej funkcji, ponieważ żadne domy w pobliżu nie mają na nie zapotrzebowania."},
    {TR_BUILDING_LIGHTHOUSE_NO_TIMBER, "Latrnicy mają trudności ze znalezieniem opału koniecznego do utrzymania światła na szczycie. Statki zawijające do twoich portów próżnie wypatrują lądu."},
    ...
    {TR_BUILDING_SMALL_MAUSOLEUM_PHASE_2_TEXT, "Umiejętni rzemieślnicy przygotowywują fasdę tego mauzoleum, przygotowywując marmur pod pośmiertne maski zacnych obywateli, którzy będą mieli zaszczyt tu spocząć."},
    ...
    {TR_TOOLTIP_BUTTON_ACCEPT_CARAVANSERAI, "Zezwól Caravanserai na pobieranie zasobów z tego miejsca"},
    ...
    {TR_TOOLTIP_BUTTON_REJECT_CARAVANSERAI, "Nie zezwalaj Caravanserai na pobieranie zasobów z tego miejsca"},
