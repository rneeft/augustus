...
static translation_string all_strings[] = {
    ...
    {TR_AUTO_CYCLE_TEMPLES, "Całość"}, // TODO "Auto. przełączanie" ?
    {TR_BUTTON_OK, "OK"},
    ...
    {TR_CONFIG_DRAW_WEATHER, "Włącz efekty pogodowe"},
    ...
    {TR_ADVISOR_AVAILABLE_HOUSING_CAPACITY, "Wolne miejsca:"}, // has to be short
    {TR_ADVISOR_TOTAL_HOUSING_CAPACITY, "Pojemność:"}, // has to be short
    ...
    { TR_CONFIG_GETTING_GRANARIES_GO_OFFROAD, "Popychacze wozów ze zbierających spichlerzy mogą schodzić z dróg" },
    { TR_CONFIG_GRANARIES_GET_DOUBLE, "Podwój pojemność zbierających popychaczy wozów ze spichlerzy" },
    { TR_CONFIG_TOWER_SENTRIES_GO_OFFROAD, "Strażnicy z wież mogą schodzić z dróg" },
    ...
    { TR_CONFIG_NOT_ACCEPTING_MARKETS, "Stragany nie akceptują żadnych dóbr przy zbudowaniu" },
    ...
    { TR_BUILDING_GRAND_TEMPLE_MARS_BONUS_DESC, "Szkoli żołnierzy jak koszary. Zezwala na budowę dodatkowych czterech fortów" }, // needs update ? not sure about the "szkoli" part
    ...
    { TR_BUILDING_GRAND_TEMPLE_CERES_DESC_MODULE_1, "Świątynia Ceres Fecunda" },
    { TR_BUILDING_GRAND_TEMPLE_CERES_DESC_MODULE_2, "Świątynia Ceres Frugifera" },
    ...
    { TR_BUILDING_GRAND_TEMPLE_MERCURY_DESC_MODULE_2, "Świątynia Mercurius Mercator" },
    ...
    { TR_BUILDING_BARRACKS_FOOD_WARNING_2, "Krytyczne braki w żywności w punkcie zaopatrzeniowym wielce spowalniają rekrutację." },
    ...
    { TR_ADVISOR_LEGION_FOOD_SATISFIED, "Twoi żołnierze są wystarczająco wyżywieni." },
    ...
    { TR_CITY_MESSAGE_TEXT_MESS_HALL_NEEDS_FOOD, "Twój punkt zaopatrzeniowy krytycznie potrzebuje żywności. Zapewnij dostęp do pełnego spichlerza." },
    ...
    { TR_CITY_MESSAGE_TEXT_GRAND_TEMPLE_COMPLETE, "Kapłani i wyznawcy tłumnie gromadzą się w nowej wielkiej świątyni na ryty poświęcenia. Mieszkańcy są w podziwie majestatu twojej pracy, a wybrane bóstwo obdarza cię swoją łaską." },
    ...
    { TR_FIGURE_TYPE_WORK_CAMP_ARCHITECT, "Inżynier" },
    ...
    { TR_CITY_MESSAGE_TEXT_PANTHEON_FESTIVAL_MERCURY, "Kupcy i handlarze tłumnie zbierają się do świętowania Merkuraliów. Statki i hurtownie pokrapiane są świętą wodą, licząć na boską ochronę Merkurego."},
    ...
    { TR_BUILDING_LIGHTHOUSE_PHASE_4_TEXT, "Inżynierowie wykańczają latarnię. Niedługo będzie świecić na wiele mil, zapewniając statkom drogę do domu." },
    ...
    { TR_CITY_MESSAGE_TEXT_PANTHEON_COMPLETE, "Panteon ukończony. Jest to niezrównany pomnik potęgi Rzymskiego ludu i jego bogów." },
    ...
    { TR_CITY_MESSAGE_TEXT_VENUS_BLESSING, "Uradowana twoim oddaniem, Venus nagradza twoich mieszkańców zdrowiem, szczęściem i młodością, zwiększając liczbę pracujących mieszkańców." },
    ...
    { TR_ADVISOR_DISPATCHING_FOOD_FROM_GRANARIES_TITLE, "Wysyłanie jedzenia ze spichlerza"},
    ...
    { TR_ADVISOR_MAX_ATTAINABLE_PROSPERITY_IS, "Maksymalny poziom dobrobytu dla tego poziomu mieszkania jest" },
    ...
    { TR_ADVISOR_TRADE_NO_BUYERS, "Nikt nie kupuje tego surowca" },
    { TR_ADVISOR_TRADE_NO_SELLERS, "Nikt nie sprzedaje tego surowca" },
    ...
    { TR_BUILDING_CARAVANSERAI_DESC, "Karawany handlowe zatrzymują się tu, aby odpocząć i nakarmić swoje zwierzęta. Zakłócenia w handlu lądowym trwają o połowę krócej." },
    ...
    { TR_BUILDING_CARAVANSERAI_POLICY_2, "Polityka lądowego kupcy: Import lądowy kosztuje 20% mniej." },
    ...
    {TR_BUILDING_COLOSSEUM_PHASE_3_TEXT, "Pełne wdzięku łuki wznoszą się ku niebu, aby moc utrzymać Koloseum." },
    {TR_BUILDING_COLOSSEUM_PHASE_4_TEXT, "Koloseum sięga już nieba a jego ściany są pokrywane błyszczącym marmurem i posągami." },
    ...
    {TR_BUILDING_GARDEN_WALL, "Zapętlona ściana ogrodowa" }, // TODO "zaokraglona" ?
    ...
    {TR_BUILDING_LEGION_STATUE, "Pomnik legionisty" },
    ...
    {TR_BUILDING_LIGHTHOUSE_POLICY_2, "Polityka morskiego kupcy: Import morski kosztuje 20% mniej." },
    ...
    {TR_BUILDING_MONUMENT_CONSTRUCTION_ARCHITECT_NEEDED, "Ten pomnik ma wszystkie materiały potrzebne do tej fazy. Pracownicy czekają na wykwalifikowanego inżyniera z gildii, który będzie nadzorować dalszą budowę." },
    {TR_BUILDING_MONUMENT_CONSTRUCTION_DESC, "Budowa pomnika wymaga materiałów przechowywanych w hurtowni, robotników z obozu pracy i inżynierów z gildii." },
    ...
    {TR_BUILDING_WINDOW_HOUSE_SENTIMENT_1, "Mieszkańcy wzdrygają się na sam dźwięk Twojego imienia!"},
    ...
    {TR_BUILDING_WINDOW_HOUSE_UPSET_HIGH_TAXES, "Mieszkańcy są niezadowoleni z powodu wysokich podatków." },
    {TR_BUILDING_WINDOW_HOUSE_UPSET_LOW_WAGES, "Mieszkańcy są niezadowoleni z powodu niskich płac." },
    ...
    {TR_CITY_MESSAGE_TEXT_COLOSSEUM_WORKING, "Inauguracyjne rozgrywki w Twoim koloseum się rozpoczęły. Na Twój rozkaz, ten monument będzie konsekrowany krwią walecznych!" },
    ...
    {TR_CITY_MESSAGE_TEXT_LOOTING, "Hurtownia lub spichlerz zostały splądrowane przez wściekłych obywateli, a towary zostały skradzione! Niskie zadowolenie mieszkańców zwiększa prawdopodobieństwo wystąpienia takich incydentów."},
    ...
    {TR_CITY_WARNING_WAREHOUSE_BREAKIN, "Hurtownia została złupiona!" },
    ...
    {TR_CONFIG_WINDOWED_RESOLUTION, "Rozdzielczość w oknie:"},
    {TR_DOCK_SPECIAL_ORDERS_HEADER, "Instrukcje dla doku"},
    {TR_FIGURE_TYPE_BARKEEP, "Gospodarz" },
    ...
    {TR_MESS_HALL_SPECIAL_ORDERS_HEADER, "Instrukcje dla punktu zaopatrzeniowego"},
    ...
    {TR_SIDEBAR_EXTRA_REQUESTS_SEND, "Spełnij żądanie"},
    ...
    {TR_TOOLTIP_BUTTON_ROADBLOCK_PERMISSION_MARKET, "Przełączaj dostęp pracowników straganów" },
    ...
    {TR_TOOLTIP_OVERLAY_TAVERN_1, "Ten dom nie ma dostępu do tawerny lub wyschły zapasy wina jego tawerny." },
    {TR_TOOLTIP_OVERLAY_TAVERN_2, "Żaden gospodarz nie przechodził przez jakiś czas. Ten dom wkrótce straci dostęp do swojej tawerny." },
    {TR_TOOLTIP_OVERLAY_TAVERN_3, "W pobliżu tego domu przeszedl gospodarz z winem." },
    {TR_TOOLTIP_OVERLAY_TAVERN_4, "W pobliżu tego domu przeszedl gospodarz z winem i mięsem." },
    {TR_TOOLTIP_OVERLAY_TAVERN_5, "W pobliżu tego domu przeszedl niedawno gospodarz z winem." },
    {TR_TOOLTIP_OVERLAY_TAVERN_6, "W pobliżu tego domu przeszedl niedawno gospodarz z winem i mięsem. Niech rozpocznie się zabawa!" },
    ...
    {TR_WINDOW_BUILDING_ARENA_BOTH_SHOWS, "Na tej arenie odbywają się walki gladiatorów i polowania na zwierzęta, ku uciesze mieszkańców." },
    ...
    {TR_WINDOW_BUILDING_ARENA_NEEDS_GLADIATORS, "Głodne bestie grasują po arenie w poszukiwaniu zdobyczy, ale brak wyszkolonych gladiatorów ukróca pokazy." },
    ...
    {TR_WINDOW_BUILDING_LARARIUM_DESC, "Ta mała świątynia poświęcona jest duchom przodków ludu rzymskiego. Można się tu modlić oraz składać małe ofiary."},
    ...
    {TR_WINDOW_BUILDING_WHARF_MOTHBALLED, "Twój doradca handlowy nakazał wstrzymanie połowu ryb."},
    ...
    {TR_WINDOW_GAMES_OPTION_4_DESC, "Hipodrom będzie gospodarzem igrzysk olimpijskich. Twoje miasto będzie gościć rzesze odwiedzających, a jeśli Twoi sportowcy dobrze się sprawią, zyskasz łaskę Cezara i przychylność mieszkańców." },
    ...
    {TR_WINDOW_RACE_BET_DESCRIPTION, "Postaw określoną kwotę na wybraną drużynę rydwanów i podwój stawkę, jeśli twój koń wygra. Twoje zarobki zostaną nawet czterokrotnie zwiększone podczas igrzysk w Koloseum!" },
    ...
    {TR_BUILDING_LIGHTHOUSE_NEEDS_WORKERS, "Bez wystarczającej liczby pracowników, latarnia nie może utrzymać ognia przez cały dzień. Statki z trudem znajdują doki naszego miasta."},
    ...
    {TR_WINDOW_BUILDING_DISTRIBUTION_CART_PUSHER_GETTING, "Pchacz wozu jest w drodze, aby odebrać towary z innej hurtowni." },
    ...
    {TR_TOOLTIP_BUTTON_STOCKPILING_ON, "Włącz bezpośrednie dostawy do hurtowni" },
    {TR_TOOLTIP_BUTTON_STOCKPILING_OFF, "Wyłącz dostawy do hurtowni" },
    {TR_TOOLTIP_BUTTON_ACCEPT_WORKERS, "Wstrzymaj dostarczanie zasobów z hurtowni" },
    ...
    {TR_BUILDING_WAREHOUSE_PLAGUE_DESC, "Zarażony pracownik sprowadził tutaj zarazę. Ta hurtownia jest w kwarantannie do czasu odkażenia." },
    ...
    {TR_CITY_MESSAGE_TEXT_EMPERORS_WRATH, "Popadłeś w niełaskę u Cezara i zarządził on Twoje aresztowanie. Jeżeli nie zdołasz wrócić do jego łask, wkrótce elitarni legioniści zaatakują Twoje miasto!" },
    ...
    {TR_SAVE_DIALOG_FILE_DOES_NOT_EXIST_TITLE, "Plik nie istnieje"},
    {TR_SAVE_DIALOG_FILE_DOES_NOT_EXIST_TEXT, "Wybrany plik nie istnieje.\nWybierz inny plik."},
    ...
    { TR_ACTION_TYPE_REQUEST_IMMEDIATELY_START, "Natychmiastowo rozpocznij żądanie" },
    ...
    { TR_BUILDING_BRICKWORKS_COMPLETE, "zakończona." }, // produkcja jest x% zakończona.
    ...
    { TR_BUILDING_BRICKWORKS_NO_RESOURCES, "Temu warsztatu trzeba dostarczać glinę i piasek z hurtowni lub piaskowni i glinianki do produkcji cegieł." },
    ...
    { TR_BUILDING_CARAVANSERAI_PHASE_2, "(Kolumnada)" },
    ...
    { TR_BUILDING_CITY_MINT_DESC_ALTERNATIVE, "Tutaj przetapia się monety na złoto, które można wykorzystać do budowy pomników." },
    { TR_BUILDING_CITY_MINT_DESC_NO_PALACE, "Zbuduj swój pałac, aby zbierać także środki osobiste z mennicy miejskiej." },
    { TR_BUILDING_CITY_MINT_DESC_PALACE, "Ponieważ posiadasz pałac, do Twoich osobistych środków spływają dodatkowe denary." },
    ...
    { TR_BUILDING_CITY_MINT_NO_GOLD, "Ten warsztat potrzebuje złota dostarczonego do niego z hurtowni lub kopalni złota, aby wybić monetę." },
    { TR_BUILDING_CITY_MINT_NO_SENATE, "Budynek wymaga aktywnego senatu do działania. Bez takiego budynku nie można wybijać monet." },
    ...
    { TR_BUILDING_CONCRETE_MAKER_NO_RESOURCES, "Ten warsztat potrzebuje dostępu do wody ze zbiornika, fontanny czy studni oraz dostarczanego do niego piasku z hurtowni lub piaskowni do mieszania betonu." },
    ...
    { TR_BUILDING_DEPOT_DESC, "Skład wózków wysyła wózki do przemieszczania towarów pomiędzy hurtowniami a spichlerzami na podstawie zamówienia. Po każdej dostawie, wózki muszą wrócić do składu." },
    { TR_BUILDING_DEPOT_FEW_EMPLOYEES, "Nie ma tu prawie żadnych pracowników. Nikt nie pamięta, kiedy ten skład wysłał swój ostatni wózek." },
    ...
    { TR_BUILDING_DEPOT_SOME_EMPLOYEES, "W tym składzie pracuje bardzo mało osób. Przesyłanie towarów zajmuje trochę czasu." },
    ...
    { TR_BUILDING_INFO_CARTLOAD, "ładunek wózka." }, // zajęte/miejsce na jeden..
    { TR_BUILDING_INFO_CARTLOADS, "ładunki wózków." }, // zajęte/miejsce na xx ..
    ...
    {TR_BUILDING_LOOPED_GARDEN_WALL_GATE, "Zaokrąglona brama ogrodowa"},
    ...
    {TR_BUILDING_MESS_HALL_NO_FOOD, "Ten punkt zaopatrzeniowy zatrudnia pracowników, ale obecnie poszukuje dostępnego źródła żywności." },
    {TR_BUILDING_OVERGROWN_GARDENS, "Zarośnięte ogrody" },
    {TR_BUILDING_PANELLED_GARDEN_WALL, "Panelowa ściana ogrodowa"},
    {TR_BUILDING_PANELLED_GARDEN_WALL_GATE, "Panelowa brama ogrodowa" },
    ...
    {TR_BUILDING_SAND_PIT, "Piaskownia"},
    {TR_BUILDING_SAND_PIT_COMPLETE, "zakończone."},
    {TR_BUILDING_SAND_PIT_DESC, "Piasek jest potrzebny do budowy monumentów."},
    ...
    {TR_BUILDING_SAND_PIT_FULL_EMPLOYEES, "Piaskownia ta zatrudnia wszystkich potrzebnych pracowników i pracuje pełną parą, wydobywając piasek."},
    {TR_BUILDING_SAND_PIT_HALF_EMPLOYEES, "W tej piaskowni jest za mało personelu. Wydobywanie piasku trwa dłużej niż powinno."},
    {TR_BUILDING_SAND_PIT_HALTED, "Twój doradca handlowy nakazał wstrzymanie wydobycia piasku."},
    {TR_BUILDING_SAND_PIT_MANY_EMPLOYEES, "Piaskownia ta pracuje poniżej maksymalnej wydajności. Wydobywanie piasku mogłoby być nieco bardziej wydajne przy większej liczbie pracowników."},
    {TR_BUILDING_SAND_PIT_NO_EMPLOYEES, "W tej piaskowni nie ma pracowników. Produkcja została wstrzymana."},
    {TR_BUILDING_SAND_PIT_PRODUCTION, "Wydobycie jest"},
    {TR_BUILDING_SAND_PIT_SOME_EMPLOYEES, "W tej piaskowni pracuje bardzo niewiele osób. W rezultacie produkcja piasku jest powolna."},
    ...
    {TR_BUILDING_STONE_QUARRY_DESC, "Wydobywa kamień na budowę pomników."},
    ...
    {TR_BUILDING_WAREHOUSE_NO_GOODS, "W tej hurtowni nie są przechowywane żadne towary."},
    ...
    {TR_CITY_WARNING_BUILD_SAND_PIT, "Zbuduj piaskownię"},
    ...
    {TR_CONFIG_DRAW_CLOUD_SHADOWS, "Rysuj cienie chmur"},
    {TR_CONFIG_GATES_DEFAULT_TO_PASS_ALL_WALKERS, "Bramy niemilitarne domyślnie przepuszczają wszystkich obywateli"},
    {TR_CONFIG_SHOW_MARKET_RANGE, "Pokaż zasięg przy budowie nowych straganów"},
    ...
    {TR_EDITOR_FAVOUR_DISFAVOR, "Utrata łaski w przypadku przedłużenia"},
    ...
    {TR_EDITOR_SCENARIO_EVENTS_EXPORT_FULL, "Eksportuj wydarzenia scenariusza" },
    {TR_EDITOR_SCENARIO_EVENTS_IMPORT, "Importuj" },
    {TR_EDITOR_SCENARIO_EVENTS_IMPORT_FULL, "Importuj wydarzenia scenariusza" },
    {TR_EDITOR_SCENARIO_EVENTS_TITLE, "Wydarzenia scenariusza" },
    ...
    {TR_EDITOR_SCENARIO_SELECT_INTRO, "Wybierz wstęp do scenariusza"},
    {TR_EDITOR_SELECTED_COORDS, "Wybrane współrzędne: "},
    {TR_EDITOR_SHORT_ROUTE_TEXT, "tr"},
    ...
    {TR_EDITOR_UNABLE_TO_LOAD_EVENTS_TITLE, "Nie wczytuje się wydarzenie scenariusza"},
    {TR_EDITOR_UNABLE_TO_SAVE_EVENTS_TITLE, "Błąd w zapisywaniu wydarzeń scenariusza"},
    ...
    {TR_HOTKEY_SHOW_OVERLAY_DESIRABILITY, "Nakładka atrakcyjnośći"},
    ...
    {TR_PARAMETER_DISPLAY_IGNORE_SETTINGS, "ignorując ustawienia"},
    ...
    {TR_PARAMETER_VALUE_BUILDING_NATIVE_CROPS, "Tubylcze uprawy"},
    ...
    {TR_PARAMETER_VALUE_ENEMY_UNDEFINED, "Według mapy"},
    ...
    {TR_PARAMETER_VALUE_MESSAGE_ENEMIES_AT_THE_DOOR, "Wrogowie u bram"},
    ...
    {TR_PARAMETER_VALUE_STORAGE_TYPE_WAREHOUSES, "Hurtownie"},
    ...
    {TR_ACTION_TYPE_CAUSE_BLESSING, "Spowoduj błogosławieństwo"},
    {TR_ACTION_TYPE_CAUSE_MAJOR_CURSE, "Spowoduj wielką klątwę"},
    {TR_ACTION_TYPE_CAUSE_MINOR_CURSE, "Spowoduj pomniejszą klątwę"},
    {TR_ACTION_TYPE_CHANGE_CLIMATE, "Zmień klimat"},
    {TR_ADVISOR_HEALTH_RATING, "Wynik:"},
    {TR_ADVISOR_HEALTH_SURVEILLANCE, "Monitorowanie choroby:"},
    {TR_BUILDING_AMPHITHEATER_DESC_UPGRADED_BOTH_SHOWS, "Ten amfiteatr oferuje swojej społeczności zarówno ekscytujące pojedynki gladiatorów, jak i sztuki wystawiane przez lokalnych aktorów. Tutejszy rozwój pozwolił mieszkańcom powiększyć budynek, zwiększając jego pojemność, a widownia pozostaje wypełniona po brzegi."},
    {TR_BUILDING_AMPHITHEATER_DESC_UPGRADED_NO_ACTORS, "Ten amfiteatr oferuje swojej społeczności ekscytujące pojedynki gladiatorów, lecz brak mu sztuk które wystawiane byłyby pomiędzy walkami. Tutejszy rozwój pozwolił mieszkańcom powiększyć budynek, choć nabór aktorów pozoliłby upewnić się, że widownia pozostaje wypełniona po brzegi."},
    {TR_BUILDING_AMPHITHEATER_DESC_UPGRADED_NO_GLADIATORS, "Ten amfiteatr wystawia sztuki przedstawiane przez lokalnych aktorów, lecz brak mu widowiskowych walk gladiatorów. Tutejszy rozwój pozwolił mieszkańcom powiększyć budynek, choć nabór gladiatorów pozoliłby upewnić się, że widownia pozostaje wypełniona po brzegi."},
    {TR_BUILDING_AMPHITHEATER_DESC_UPGRADED_NO_SHOWS, "Ten amfiteatr nigdy nie wystawia żadnych przedstawień. Potrzeba mu gladiatorów i aktorów by zapewnić rozrywkę. Tutejszy rozwój pozwolił mieszkańcom powiększyć budynek, lecz dodatkowe miejsca świecą pustkami."},
    {TR_BUILDING_ARENA_DESC_UPGRADED_BOTH_SHOWS, "Ku uciesze tutejszych mieszkańców, ta arena gości zarówno gladiatorów jak i egzotyczne zwierzęta. Tutejszy rozwój pozwolił mieszkańcom powiększyć budynek, zwiększając jego pojemność, a widownia pozostaje wypełniona po brzegi."},
    {TR_BUILDING_ARENA_DESC_UPGRADED_NO_GLADIATORS, "Egzotyczne bestie przemierzają arenę w poszukiwaniu ofiar, lecz brak trenowanych gladiatorów sprawia, że przedstawienia są dość nudne."},
    {TR_BUILDING_ARENA_DESC_UPGRADED_NO_LIONS, "Ta arena gości regularne widowiska z udziałem gladiatorów, lecz dodatek lwów pozwoliłby wznieść jakość tych pokazów na nowe wyżyny. Tutejszy rozwój pozwolił mieszkańcom powiększyć budynek, choć tresowane lwy pozwoliłyby upewnić się, że widownia pozostaje wypełniona po brzegi."},
    {TR_BUILDING_ARENA_DESC_UPGRADED_NO_SHOWS, "Ta arena nie gości ani gladiatorów, ani egzotycznych zwierząt i zapewnia mierną rozrywkę. Tutejszy rozwój pozwolił mieszkańcom powiększyć budynek, lecz dodatkowe miejsca świecą pustkami "},
    {TR_BUILDING_ARMOURY, "Zbrojownia"},
    {TR_BUILDING_ARMOURY_DESC, "Zbrojownia szybko i sprawnie wyposaża naszych żołnierzy w konieczną broń. Ci barbarzyńcy nie mają szans z Rzymską logistyką!"},
    {TR_BUILDING_ARMOURY_MANY_EMPLOYEES, "Zbrojownia jest w stanie zapewnić dostawy broni do naszych koszarów, lecz braki w zatrudnieniu powodują okazjonalne deficyty."},
    {TR_BUILDING_ARMOURY_NO_EMPLOYEES, "Bez dostępu do pracowników, zbrojownia nie może zapewnić dostaw broni naszym żołnierzom. Niech Mars ma nas w swojej opiece, bo nieuzbrojony legion stanowi marną pociechę w razie ataku!"},
    {TR_BUILDING_ARMOURY_SOME_EMPLOYEES, "Ta zbrojownia nie jest w pełni obsadzona, więc wyekwipowanie naszych legionów zajmie jej sporo czasu. Oby nasi wrogowie się nie śpieszyli!"},
    {TR_BUILDING_BOTH_MAUSOLEUM_DESC, "To mauzoleum zadowala wszystkim bogów, choć nie jest zbyt atrakcyjnym sąsiedztwem. Takie miejsca spoczynku polepszają warunki sanitarne miasta, zwiększając ocenę zdrowia twoich mieszkańców."},
    {TR_BUILDING_CARAVANSERAI_FOOD_SHORTAGE, "Karawanseraj ma pracowników i jedzenie, lecz poziom zapasów jest zbyt niski by wykarmić wszystkie kupieckie karawany."},
    {TR_BUILDING_CARAVANSERAI_NO_EMPLOYEES, "Karawanseraj nie ma pracowników. Nikt nie dostarcza zapasów."},
    {TR_BUILDING_CITY_MINT_PHASE_2, "(Mennica)"},
    {TR_BUILDING_CITY_MINT_PHASE_2_TEXT, "Rzemieślnicy wykańczają 'Mennicę', gdzie wybijana będzie waluta oraz rozbudowywują magazyny służące do przechowywania surowców i kwatery dla pracowników."},
    {TR_BUILDING_FORT_ARCHERS, "Wsparcie - Łuki"},
    {TR_BUILDING_FORT_AUXILIA_INFANTRY, "Wsparcie - Miecze"},
    {TR_BUILDING_FORT_JAVELIN, "Wsparcie - Oszczepy"},
    {TR_BUILDING_FORT_LEGIONARIES, "Legioniści"},
    {TR_BUILDING_FORT_MOUNTED, "Wsparcie - Kawaleria"},
    {TR_BUILDING_INFO_CARAVANSERAI_MONTHLY_CONSUMPTION, "Miesięczna konsumpcja żywności:"},
    {TR_BUILDING_LARGE_TEMPLE_PHASE_2, "(Fasada)"},
    {TR_BUILDING_LARGE_TEMPLE_PHASE_2_TEXT, "Umiejętni rzemieślnicy przygotowywują fasadę tej świątyni, przekłuwając lśniący marmur w oblicza bóstwa które będzie tu wielbione."},
    {TR_BUILDING_LATRINES, "Latryny"},
    {TR_BUILDING_LATRINES_DESC_1, "Miejsce komfortu doceniane przez populację chcącą przedysktuwać wydarzenia dnia i ubić interesy."},
    {TR_BUILDING_LATRINES_DESC_2, "Latryny są wykorzystywane przez mieszkańców którzy mają jedynie dostęp do studni, i pomagają polepszyć warunki sanitarne i mieszkaniowe. Domy w zasięgu fontanny nie korzystają z publicznych latryn."},
    {TR_BUILDING_LATRINES_MISSING_DEVOLVE, "Ten dom straci niedługo na wartości, ponieważ nie ma dostępu do latryny lub czystej wody z fontanny."},
    {TR_BUILDING_LATRINES_MISSING_EVOLVE, "Ten dom nie może się rozwijać, ponieważ nie ma dostępu do latryny lub czystej wody z fontanny."},
    {TR_BUILDING_LATRINES_NO_HOUSES, "Te latryny nie są obecnie potrzebne, ponieważ nie ma w pobliżu żadnych domów."},
    {TR_BUILDING_LATRINES_NO_WORKERS, "Bez pracowników utrzymujących latryny, mieszkańcy unikają tego miejsca."},
    {TR_BUILDING_LATRINES_UNNECESSARY, "Te latryny nie pełnią tu żadnej funkcji, ponieważ żadne domy w pobliżu nie mają na nie zapotrzebowania."},
    {TR_BUILDING_LIGHTHOUSE_NO_TIMBER, "Latarnicy mają trudności ze znalezieniem opału koniecznego do utrzymania światła na szczycie. Statki zawijające do twoich portów próżnie wypatrują lądu."},
    {TR_BUILDING_MESS_HALL_NO_EMPLOYEES, "Ten punkt zaopatrzenia nie ma pracowników. Nikt nie dostarcza zapasów."},
    {TR_BUILDING_NATIVE_DECORATION_DESC, "Jako produkt lokalnych rzemieślników, ta dekoracja jest doceniana przez tubylców i Rzymian. Choć brak jej kunsztu, wielu mieszkańców docenia jej osobliwy urok."},
    {TR_BUILDING_NATIVE_HUT_ALT, "Alternatywna chata tubylców."},
    {TR_BUILDING_NATIVE_MONUMENT_DESC, "Ta oszałamiająca rozmachem struktura góruje nad tymi ziemiami od niepamiętnych czasów. Niektórzy głoszą, że dowodzi ona potencjału tubylców, którzy potrafią tworzyć imponujące konstrukcje mimo swoich braków w dziedzinie inżynierii. Inni, bardziej sceptyczni myśliciele spekulują, iż może być to cud zesłany z niebios lub arefakt zapomnianej, zaawansowanej cywilizacji."},
    {TR_BUILDING_NATIVE_WATCHTOWER_DESC, "Używając tych struktur, tubylcy obserwują uważnie każdy ruch w twoim mieście, zawsze gotowi wykorzystać każdy znak słabości. Jeśli nie nauczymy tych barbarzyńców rozumu i Rzymskich wartości, strażnicy z tej wieży skutecznie udaremnią nasze wysiłki ekspansji."},
    {TR_BUILDING_NYMPHAEUM_PHASE_1, "(Cella)"},
    {TR_BUILDING_NYMPHAEUM_PHASE_1_TEXT, "Kamieniarze wykańczają ściany i pilary 'Celli', a wkrótce wnętrze tej świątyni wypełnią ikony i malowidła nymf i ich świętych wód."},
    {TR_BUILDING_NYMPHAEUM_PHASE_2, "(Fasada)"},
    {TR_BUILDING_NYMPHAEUM_PHASE_2_TEXT, "Umiejętni rzemieślnicy przygotowywują fasadę tej świątyni, dekorując lśniący marmur przedstawieniami muszli i mozaikami scen wodnych."},
    {TR_BUILDING_ORACLE_DESC, "Ten pełen przepychu budynek jest zadedykowany wszystkim bóstwom, od lokalnch bożków do samego Jowisza. Tak pobożne miejsce z pewnością zapewni Ci boską opatrzność."},
    {TR_BUILDING_ORACLE_PHASE_1, "(Cella)"},
    {TR_BUILDING_ORACLE_PHASE_1_TEXT, "Kamieniarze wykańczają ściany i pilary 'Celli', a wnętrze tej wyroczni wkrótce wypełni się pobożnymi malowidłami."},
    {TR_BUILDING_ORACLE_PHASE_2, "(Fasada)"},
    {TR_BUILDING_ORACLE_PHASE_2_TEXT, "Umiejętni rzemieślnicy przygotowywują fasadę tej wyroczni, wykuwając w lśniącym marmurze oblicza bógów którzy będą tu wielbieni."},
    {TR_BUILDING_SMALL_MAUSOLEUM_PHASE_1, "(Komnata)"},
    {TR_BUILDING_SMALL_MAUSOLEUM_PHASE_1_TEXT, "Kamieniarze kładą warstwy precyzyjnie obrobionego kamienia aby uformować główną komnatę tego mauzoleum."},
    {TR_BUILDING_SMALL_MAUSOLEUM_PHASE_2, "(Fasada)"},
    {TR_BUILDING_SMALL_MAUSOLEUM_PHASE_2_TEXT, "Umiejętni rzemieślnicy przygotowywują fasadę tego mauzoleum, przygotowywując marmur pod pośmiertne maski zacnych obywateli, którzy będą mieli zaszczyt tu spocząć."},
    {TR_BUILDING_TAVERN_DESC_UPGRADED_WINE_AND_FOOD, "W tej tawernie wino leje się strumieniami, a zapach smażonych mięs przyciąga rozbawiony tłum obietnicami muzyki, hazardu i innych uciech. Tutejszy rozwój pozwolił powiększyć budynek, zapewniając więcej miejsca dla klientów."},
    {TR_BUILDING_TAVERN_DESC_UPGRADED_WINE_NO_FOOD, "Ta tawerna zabawia twoich mieszkaców dopóki starcza jej wina. Zapas mięsa lub ryb pozwoliłby zwiększyć jej atrakcyjność. Tutejszy rozwój pozwolił powiększyć budynek, zapewniając więcej miejsca dla klientów."},
    {TR_CHEAT_BUILDINGS_INVINCIBLE, "Zbudowane budynki nie niszczeją."},
    {TR_CHEAT_CASTED_CURSE, "Rzuć klątwę"},
    {TR_CHEAT_CLIMATE_CHANGE, "Klimat zmieniony"},
    {TR_CHEAT_EDITOR_WARNING_TITLE, "Ostrzeżenie"},
    {TR_CITY_MESSAGE_TEXT_CARAVANSERAI_COMPLETE, "Karawanseraj został ukończony i nowe sposobności handlowe z pewnościa wkrótce się pojawią. Karawany z całego świata zapewniają, że nie mogą się doczekać przybycia i handlu z twoim miastem."},
    ...
    {TR_CONFIG_DRAW_ASCLEPIUS, "Berło Asklepiosa dla menu zdrowia"},
    {TR_CONFIG_HIGHLIGHT_SELECTED_BUILDING, "Podświetl wybrany budynek"},
    ...
    {TR_CONFIG_USER_PATH_WITH_SUBDIRECTORIES, "Folder instalacyjny Cezara III, z podfolderami"},
    {TR_CONFIG_WAREHOUSES_GRANARIES_OVER_ROAD_PLACEMENT, "Pozwól na budowanie hurtowni i spichlerzy na drogach"},
    {TR_EDITOR_ALLOWED_BUILDINGS_ALLOWED, "Dozwolone"},
    {TR_EDITOR_ALLOWED_BUILDINGS_NOT_ALLOWED, "Niedozowolone"},
    {TR_EDITOR_AND, "i"},
    {TR_EDITOR_RETURN_TO_CITY, "Powrót do miasta"},
    {TR_EDITOR_SCENARIO_BUILDING_NATIVE_DECORATION, "Dekoracja"},
    {TR_EDITOR_SCENARIO_BUILDING_NATIVE_HUT_ALT, "Alternatywna chata tubylców"},
    {TR_EDITOR_SCENARIO_BUILDING_NATIVE_MONUMENT, "Monument"},
    {TR_EDITOR_SCENARIO_BUILDING_NATIVE_WATCHTOWER, "Strażnica"},
    {TR_EDITOR_SCENARIO_DESELECT_VICTORY, "Usuń wiadomość zwycięstwa"},
    {TR_FIGURE_ENEMY_CATAPULT, "Katapulta"},
    {TR_FIGURE_TYPE_ARMORY_CARTPUSHER, "Dostawca zbrojowni"},
    {TR_FIGURE_TYPE_BEGGAR, "Żebrak"},
    {TR_HOTKEY_SHOW_OVERLAY_EMPLOYMENT, "Nakładka zatrudnienia"},
    {TR_HOTKEY_SHOW_OVERLAY_ENEMY, "Nakładka wrogów"},
    {TR_HOTKEY_SHOW_OVERLAY_HEALTH, "Nakładka zdrowia"},
    {TR_HOTKEY_SHOW_OVERLAY_LOGISTICS, "Nakładka logistyki"},
    {TR_MAIN_MENU_SELECT_CAMPAIGN, "Rozpocznij nową kampanię"},
    {TR_ORIGINAL_CAMPAIGN_FIRST_MISSION, "Samouczek 1"},
    {TR_ORIGINAL_CAMPAIGN_SECOND_MISSION, "Brundisium: Samouczek 2"},
    {TR_OVERLAY_EMPLOYMENT, "Zatrudnienie"},
    {TR_OVERLAY_HEALTH, "Globalne"},
    {TR_OVERLAY_LOGISTICS, "Logistyka"},
    {TR_PARAMETER_TYPE_CLIMATE, "Klimat"},
    {TR_PARAMETER_TYPE_GOD, "Bóg"},
    {TR_PARAMETER_TYPE_REQUEST, "Żądanie"},
    {TR_PARAMETER_VALUE_CLIMATE_CENTRAL, "Centralny"},
    {TR_PARAMETER_VALUE_CLIMATE_DESERT, "Pustynny"},
    {TR_PARAMETER_VALUE_CLIMATE_NORTHERN, "Północny"},
    {TR_PARAMETER_VALUE_GOD_CERES, "Ceres"},
    {TR_PARAMETER_VALUE_GOD_MARS, "Mars"},
    {TR_PARAMETER_VALUE_GOD_MERCURY, "Merkury"},
    {TR_PARAMETER_VALUE_GOD_NEPTUNE, "Neptun"},
    {TR_PARAMETER_VALUE_GOD_VENUS, "Wenus"},
    {TR_PARAMETER_VALUE_MEDIA_TYPE_SPEECH, "Mowa"},
    {TR_PARAMETER_VALUE_MEDIA_TYPE_BACKGROUND_IMAGE, "Obraz tła"},
    {TR_REPLAY_MAP_NOT_FOUND_MESSAGE, "Oryginalny plik mapy dla tego zapisy gry nie został odnaleziony.\nWymagany jest plik o rozszerzeniu .map albo .mapx:"},
    {TR_REPLAY_MAP_NOT_FOUND_TITLE, "Nie udało się powtórzyć mapy:"},
    {TR_WINDOW_ORIGINAL_CAMPAIGN_NAME, "Oryginalna kampania" },
    {TR_WINDOW_ORIGINAL_CAMPAIGN_DESC, "Oryginalna kampania z 1998 r., w całej swojej starożytnej chwale."},
    {TR_WINDOW_CAMPAIGN_BUTTON_BEGIN_CAMPAIGN, "Rozpocznij kampanię"},
    {TR_WINDOW_CAMPAIGN_BUTTON_MISSION_LIST, "Wybór scenariusza"},
    {TR_WINDOW_CAMPAIGN_CURRENT_MISSION, "Aktualny scenariusz:"},
    {TR_WINDOW_CAMPAIGN_FINISHED, "Kampania ukończona"},
    {TR_WINDOW_MISSION_LIST_CAMPAIGN_NOT_FINISHED, "Kampania nieukończona"},
    {TR_WINDOW_BARRACKS_FORTS, "Forty"},
    {TR_WINDOW_BARRACKS_TOWERS, "Wieźe"},
    {TR_TOOLTIP_BARRACKS_PRIORITY_FORT, "Ustaw priorytet szkolenia: Legioniści"},
    {TR_TOOLTIP_BARRACKS_PRIORITY_JAVELIN, "Ustaw priorytet szkolenia: Oszczepy"},
    {TR_TOOLTIP_BARRACKS_PRIORITY_MOUNTED, "Ustaw priorytet szkolenia: Kawaleria"},
    {TR_TOOLTIP_BARRACKS_PRIORITY_AUXINF, "Ustaw priorytet szkolenia: Miecze"},
    {TR_TOOLTIP_BARRACKS_PRIORITY_AUXARCH, "Ustaw priorytet szkolenia: Łuki"},
    {TR_TOOLTIP_BARRACKS_PRIORITY_TOWER, "Ustaw priorytet szkolenia: Strażnicy"},
    {TR_TOOLTIP_BARRACKS_PRIORITY_WATCHTOWER, "Ustaw priorytet szkolenia: Wartownicy"},
    {TR_TOOLTIP_BUTTON_ACCEPT_ARMOURY, "Zezwól zbrojowniom na pobieranie zasobów z tego miejsca"},
    {TR_TOOLTIP_BUTTON_ACCEPT_BARKEEP, "Zezwól tawernom na pobieranie zasobów z tego miejsca"},
    {TR_TOOLTIP_BUTTON_ACCEPT_CARAVANSERAI, "Zezwól karawanserajom na pobieranie zasobów z tego miejsca"},
    {TR_TOOLTIP_BUTTON_ACCEPT_DELIVERY, "Zezwól zbrojowniom na dostarczanie broni do tego miejsca"},
    {TR_TOOLTIP_BUTTON_ACCEPT_LIGHTHOUSE, "Zezwól latarni morskiej na pobieranie drewna z tego miejsca"},
    {TR_TOOLTIP_BUTTON_ACCEPT_WORKCAMP, "Zezwól obozowi pracy na pobieranie zasobów z tego miejsca"},
    {TR_TOOLTIP_BUTTON_ACCEPT_NATIVES, "Zezwól tubylcom na pobieranie zasobów z tego miejsca"},
    {TR_TOOLTIP_BUTTON_REJECT_NATIVES, "Nie zezwalaj tubylcom na pobieranie zasobów z tego miejsca"},
    {TR_WARNING_NO_ARMOURY, "Zbuduj zbrojownię aby dostarczać broni do koszar" },
    {TR_TOOLTIP_BUTTON_CAN_GO_TO_ADVISORS, "Idź do doradcy odpowiadającego za ten budynek."},
    {TR_TOOLTIP_BUTTON_DELETE_COMMON_MESSAGES, "Usuń zwykłe wiadomości"},
    {TR_TOOLTIP_BUTTON_REJECT_ARMOURY, "Nie zezwalaj zbrojowniom na pobieranie zasobów z tego miejsca"},
    {TR_TOOLTIP_BUTTON_REJECT_BARKEEP, "Nie zezwalaj tawernom na pobieranie zasobów z tego miejsca"},
    {TR_TOOLTIP_BUTTON_REJECT_CARAVANSERAI, "Nie zezwalaj karawanserajom na pobieranie zasobów z tego miejsca"},
    {TR_TOOLTIP_BUTTON_REJECT_DELIVERY, "Nie zezwalaj zbrojowniom na dostarczanie broni do tego miejsca"},
    {TR_TOOLTIP_BUTTON_REJECT_LIGHTHOUSE, "Nie zezwalaj latarni morskiej na pobieranie drewna z tego miejsca"},
    {TR_TOOLTIP_BUTTON_REJECT_MARKET_LADIES, "Nie zezwalaj straganom na pobieranie zasobów z tego miejsca"},
    {TR_TOOLTIP_BUTTON_REJECT_QUARTERMASTER, "Nie zezwalaj punktowi zaopatrzenia na pobieranie jedzenia z tego miejsca"},
    {TR_TOOLTIP_BUTTON_REJECT_TRADE_CARAVAN, "Nie zezwalaj karawanom na pobieranie zasobów z tego miejsca"},
    {TR_TOOLTIP_BUTTON_REJECT_TRADE_SHIPS, "Nie zezwalaj okrętom handlowym na pobieranie zasobów z tego miejsca"},
    {TR_TOOLTIP_BUTTON_REJECT_WORKCAMP, "Nie zezwalaj obozom pracy na pobieranie zasobów z tego miejsca"},
    {TR_TOOLTIP_BUTTON_ROADBLOCK_ORDER_ACCEPT_ALL, "Akceptuj wszystkich obywateli"},
    {TR_TOOLTIP_BUTTON_ROADBLOCK_ORDER_REJECT_ALL, "Zawróć wszystkich obywateli"},
    {TR_TOOLTIP_BUTTON_ROADBLOCK_PERMISSION, "Rozkazy dla przechodzących"},
    {TR_TOOLTIP_BUTTON_STORAGE_ORDER_ACCEPT_ALL, "Akceptuj wszystkie zasoby"},
    {TR_TOOLTIP_BUTTON_STORAGE_ORDER_REJECT_ALL, "Odrzuć wszystkie zasoby"},
    {TR_TOOLTIP_OVERLAY_EMPLOYMENT_FULL, "Ten budynek ma wszystkich potrzebnych pracowników."},
    {TR_TOOLTIP_OVERLAY_EMPLOYMENT_MISSING_1, " pracownik potrzebny w tym budynku"},
    {TR_TOOLTIP_OVERLAY_EMPLOYMENT_MISSING_2, " pracowników potrzebnych w tym budynku"},
    {TR_TOOLTIP_OVERLAY_EMPLOYMENT_MOTHBALL, " pracowników potrzebnych w tym budynku (wyłączony)"},
    {TR_TOOLTIP_OVERLAY_HEALTH_NONE, "Nikt tu jeszcze nie mieszka"},
    {TR_TOOLTIP_OVERLAY_HEALTH_0, "Zdrowie w tym domu jest tragiczne"},
    {TR_TOOLTIP_OVERLAY_HEALTH_1, "Zdrowie w tym domu jest bardzo złe"},
    {TR_TOOLTIP_OVERLAY_HEALTH_2, "Zdrowie w tym domu jest złe"},
    {TR_TOOLTIP_OVERLAY_HEALTH_3, "Zdrowie w tym domu jest słabe"},
    {TR_TOOLTIP_OVERLAY_HEALTH_4, "Zdrowie w tym domu jest poniżej przeciętnej"},
    {TR_TOOLTIP_OVERLAY_HEALTH_5, "Zdrowie w tym domu jest przeciętne"},
    {TR_TOOLTIP_OVERLAY_HEALTH_6, "Zdrowie w tym domu jest dobre"},
    {TR_TOOLTIP_OVERLAY_HEALTH_7, "Zdrowie w tym domu jest bardzo dobre"},
    {TR_TOOLTIP_OVERLAY_HEALTH_8, "Zdrowie w tym domu jest doskonałe"},
    {TR_TOOLTIP_OVERLAY_HEALTH_9, "Zdrowie w tym domu jest prawie perfekcyjne"},
    {TR_TOOLTIP_OVERLAY_HEALTH_10, "Zdrowie w tym domu jest perfekcyjne"},
    {TR_USER_DIRECTORIES_CANCELLED_TITLE, "Anulowano selekcję folderu"},
    {TR_USER_DIRECTORIES_CANCELLED_TEXT, "Zdecydowano nie używać niestandardowej lokacji. Użyto domyślnej lokacji instalacji Cezara III.\n"},
    // TODO {TR_USER_DIRECTORIES_NOT_WRITEABLE_TITLE, "User directory not writable"},
    ...
    {TR_WINDOW_MESSAGE_LIST_SELECTED_ALL, "Wszystkie wiadomości"},
    {TR_WINDOW_MESSAGE_LIST_SELECTED_COMMON, "Zwykłe wiadomości"},
    {TR_WINDOW_MESSAGE_LIST_SELECTED_CUSTOM, "Niestandardowe wiadomości"},
    {TR_CHEAT_UNLOCK_LEGIONS, "Dozwolone legiony: 20"},
    {TR_BUILDING_FORT_STANDARD_ELEPHANTS, "\"Słonie\""},
    {TR_BUILDING_FORT_STANDARD_THUNDER_BOLTS, "\"Błyskawice\""},
    {TR_BUILDING_FORT_STANDARD_BULLS, "\"Byki\""},
    {TR_BUILDING_FORT_STANDARD_CENTAURS, "\"Centaury\""},
    {TR_BUILDING_FORT_STANDARD_OCTOPI, "\"Ośmiornice\""},
    {TR_BUILDING_FORT_STANDARD_BEARS, "\"Niedźwiedzie\""},
    {TR_BUILDING_FORT_STANDARD_SCORPIONS, "\"Skorpiony\""},
    {TR_BUILDING_FORT_STANDARD_CAMELS, "\"Wielbłądy\""},
    {TR_BUILDING_FORT_STANDARD_DOLPHINS, "\"Delfiny\""},
    {TR_BUILDING_FORT_STANDARD_SEA_GOATS, "\"Koziorożce\""},
    {TR_WINDOW_BUILDING_DISTRIBUTION_MAINTAINING, "Utrzymuj"},
    {TR_CONFIG_MAX_AUTOSAVE_SLOTS, "Maksymalna liczba rocznych autozapisów:"},
    // not needed for polish - TR_FIX_KOREAN_BUILDING_DOCTORS_CLINIC
    // not needed for polish - TR_FIX_GERMAN_CITY_RETAKEN
    {TR_TOOLTIP_PERSONAL_SAVINGS, "Twoje osobiste fundusze!"},
    {TR_BUILDING_NATIVE_DECORATION, "Tubylcza dekoracja."},
    {TR_BUILDING_NATIVE_MONUMENT, "Tubylczy posąg."},
    {TR_BUILDING_NATIVE_WATCHTOWER, "Tubylcza ambona zwiadowcza."},
    {TR_TOOLTIP_BUILDING_DISTRIBUTION_MAINTAINING, "Nie zezwalaj nikomu oprócz składom wózków na pobieranie tego surowca." },
    {TR_CONFIG_STORAGE_STEP_4, "Użyj wielokrotności 4 dla ilości w spichlerzu, hurtowni i składzie wózków" },
    {TR_BUILDING_FORT_MENU, "Fort"},
    {TR_PARAMETER_VALUE_BUILDING_MENU_FORTS, "Wszystkie forty"},
    // TODO 1655 - 1670
    {TR_CONFIG_DEFAULT_GAME_SPEED, "Domyślna prędkość gry:"},
    {TR_CONFIG_CATEGORY_GENERAL, "Ogólne"},
    {TR_CONFIG_CATEGORY_UI_MAP, "Przewijanie i Mapa"},
    {TR_CONFIG_CATEGORY_UI_BUILDING, "Budowanie"},
    {TR_CONFIG_CATEGORY_UI_CITY, "Zarządzanie miastem"},
    {TR_CONFIG_CATEGORY_UI_WEATHER, "Pogoda"},
