...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_NYMPHAEUM_PHASE_2_TEXT, "Umiejętni rzemieślnicy przygotowywują fasdę tej świątyni, dekorując lśniący marmur przedstawieniami muszli i mozaikami scen wodnych."},
    ...
    {TR_BUILDING_ORACLE_PHASE_1_TEXT, "Kamieniarze wykańczają ściany i pilary 'Celli', a wnętrze tej wyroczni wkórtce wypełni się pobożnymi malowidłami."},
    {TR_BUILDING_ORACLE_PHASE_2, "(Fasada)"},
    {TR_BUILDING_ORACLE_PHASE_2_TEXT, "Umiejętni rzemieślnicy przygotowywują fasdę tej wyroczni, wykuwając w lśniącym marmurze oblicza bógów którzy będą tu wielbieni."},
    {TR_BUILDING_SMALL_MAUSOLEUM_PHASE_1, "(Komnata)"},
    {TR_BUILDING_SMALL_MAUSOLEUM_PHASE_1_TEXT, "Kamieniarze kładą warstwy precyzyjnie obrobionyego kamienia aby uformować główną komnatę tego mauzoleum."},
    ...
    {TR_CONFIG_WAREHOUSES_GRANARIES_OVER_ROAD_PLACEMENT, "Pozwól na budowanie magazynów i spichlerzy "},
