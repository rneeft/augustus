...
static translation_string all_strings[] = {
    ...
    { TR_CONFIG_NOT_ACCEPTING_WAREHOUSES, "Magazyny nie akceptują żadnych dóbr przy zbudowaniu" },
    ...
    {TR_BUILDING_MONUMENT_CONSTRUCTION_DESC, "Budowa pomnika wymaga materiałów przechowywanych w magazynie, robotników z obozu pracy i inżynierów z gildii." },
    ...
    {TR_ACTION_TYPE_CAUSE_BLESSING, "Spowododuj błogosławieństwo"},
    ...
    {TR_CONFIG_WAREHOUSES_GRANARIES_OVER_ROAD_PLACEMENT, "Pozwól na budowanie magazynów i spichlerzy na drogach"},
    ...
    {TR_TOOLTIP_BARRACKS_PRIORITY_TOWER, "Ustaw priorytet szkolenia: Łuki"},
    ...
    {TR_CONFIG_STORAGE_STEP_4, "Użyj wielokrotności 4 dla ilości w spichlerzu, magazynie i składzie wózków" },
};
