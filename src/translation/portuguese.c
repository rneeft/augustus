...
static translation_string all_strings[] = {
   {TR_NO_PATCH_TITLE, "Atualização 1.0.1.0 não instalada"},
    ...
    {TR_BUILDING_LARGE_TEMPLE_PHASE_1, "(Construção)" },
    {TR_BUILDING_LARGE_TEMPLE_PHASE_1_TEXT, "Pedreiros e engenheiros estão construíndo este edifício sagrado com mármore reluzente." },
    ...
    { TR_ACTION_TYPE_CAUSE_BLESSING, "Causar bênção" },
    { TR_ACTION_TYPE_CAUSE_MAJOR_CURSE, "Causar grande maldição" },
    { TR_ACTION_TYPE_CAUSE_MINOR_CURSE, "Causar pequena maldição" },
    { TR_ACTION_TYPE_CHANGE_CLIMATE, "Mudar clima" },
    { TR_ADVISOR_HEALTH_RATING, "Índice:" },
    { TR_ADVISOR_HEALTH_SURVEILLANCE, "Fiscalização de saúde:" },
    { TR_BUILDING_AMPHITHEATER_DESC_UPGRADED_BOTH_SHOWS, "Neste anfiteatro a comunidade presencia excitantes combates de gladiadores e assiste a peças, com atores locais. O desenvolvimento local permitiu que os cidadãos expandissem o edifício, aumentando a quandidade de assentos disponíveis para assistir aos espetáculos." },
    { TR_BUILDING_AMPHITHEATER_DESC_UPGRADED_NO_ACTORS, "Neste anfiteatro há lutas de gladiadores para diversão da comunidade local. Faltam atores para encenar algumas peças. O desenvolvimento local permitiu que os cidadãos expandissem o edifício, mas a falta de atores desestimula a ocupação dos assentos extras." },
    { TR_BUILDING_AMPHITHEATER_DESC_UPGRADED_NO_GLADIATORS, "Neste anfiteatro são encenadas peças com atores locais. Poderia haver mais audiência se gladiadores combatessem ao vivo. O desenvolvimento local permitiu que os cidadãos expandissem o edifício, mas a falta de gladiadores desestimula a ocupação dos assentos extras." },
    { TR_BUILDING_AMPHITHEATER_DESC_UPGRADED_NO_SHOWS, "Neste anfiteatro não há apresentações. É preciso atores e gladiaores para haver entretenimento. O desenvolvimento local permitiu que os cidadãos expandissem o edifício, mas sem espetáculos os assentos extras permanecem vazios." },
    { TR_BUILDING_ARENA_DESC_UPGRADED_BOTH_SHOWS, "Esta arena apresenta gladiaturas e caçadas com animais, para o deleite da multidão! O desenvolvimento local permitiu que os cidadãos expandissem o edifício, aumentando a quandidade de assentos disponíveis para assistir aos espetáculos." },
    { TR_BUILDING_ARENA_DESC_UPGRADED_NO_GLADIATORS, "Feras famintas rondam a arena em busca de presas, mas o espetáculo é curto, devido à ausência de gladiadores treinados. O desenvolvimento local permitiu que os cidadãos expandissem o edifício, mas a falta de gladiadores desestimula a ocupação dos assentos extras." },
    { TR_BUILDING_ARENA_DESC_UPGRADED_NO_LIONS, "Apresentações regulares de gladiaturas entretêm a multidão, mas lutas com leões elevariam o padrão do espetáculo. O desenvolvimento local permitiu que os cidadãos expandissem o edifício, mas a falta de feras treinadas desestimula a ocupação dos assentos extras." },
    { TR_BUILDING_ARENA_DESC_UPGRADED_NO_SHOWS, "Esta arena não tem apresentações nem com leões nem com gladiadores, e provém pouco entretenimento. O desenvolvimento local permitiu que os cidadãos expandissem o edifício, mas sem espetáculos os assentos extras permanecem desocupados." },
    { TR_BUILDING_ARMOURY, "Arsenal" },
    { TR_BUILDING_ARMOURY_DESC, "O arsenal garante que os soldados sejam rapida e eficientemente equipados com armas. Aqueles bárbaros não são páreo para a logística romana!" },
    { TR_BUILDING_ARMOURY_MANY_EMPLOYEES, "O arsenal é capaz de distribuir armas para os soldados, porém a falta de trabalhadores tem causado interrupções no fornecimento." },
    { TR_BUILDING_ARMOURY_NO_EMPLOYEES, "Sem trabalhadores este arsenal não consegue distribuir armas para os soldados. Que Marte nos proteja, pois legiões desarmadas certamente não irão!" },
    { TR_BUILDING_ARMOURY_SOME_EMPLOYEES, "Como a mão de obra deste arsenal está desfalcada, equipar completamente as legiões levará um tempo considerável. Espero que nossos inimigos também levem seu tempo!" },
    { TR_BUILDING_BOTH_MAUSOLEUM_DESC, "Este mausoléu agrada a todos os deuses, embora não seja atrativo para as moradias vizinhas. Locais de sepultamento como este elevam as condições sanitárias da cidade, aumentando a saúde dos cidadãos." },
    { TR_BUILDING_CARAVANSERAI_NO_EMPLOYEES, "O Caravançará não tem trabalhadorres. Não é possível coletar alimentos." },
    { TR_BUILDING_CITY_MINT_PHASE_2, "(Moneta)" },
    { TR_BUILDING_CITY_MINT_PHASE_2_TEXT, "Os artesãos estão realizando os acabamentos na 'Moneta', local onde as moedas serão fundidas, criando espaços para o armazenamento de denários e para a acomodação dos ouríveres." },
    { TR_BUILDING_FORT_ARCHERS, "Auxiliares - Arqueiros" },
    { TR_BUILDING_FORT_JAVELIN, "Auxiliares - Lanceiros" },
    { TR_BUILDING_FORT_LEGIONARIES, "Legionários" },
    { TR_BUILDING_FORT_MOUNTED, "Auxiliares - Cavaleiros" },
    { TR_BUILDING_LARGE_TEMPLE_PHASE_2, "(Frontão)" },
    { TR_BUILDING_LARGE_TEMPLE_PHASE_2_TEXT, "Os hábeis artesãos estão trabalhando no frontão do templo, esculpindo reluzentes estátuas de mármore na imagem da divindade que será cultuada aqui." },
    { TR_BUILDING_MESS_HALL_NO_EMPLOYEES, "Este posto de suprimentos não tem trabalhadores. Não é possível coletar alimentos." },
    { TR_BUILDING_NYMPHAEUM_PHASE_1, "(Cella)" },
    { TR_BUILDING_NYMPHAEUM_PHASE_1_TEXT, "Os pedreiros estão trabalhando nas paredes e colunas da 'Cella', o interior deste templo, que irá abrigar as imagens das ninfas e suas águas sagradas." },
    { TR_BUILDING_NYMPHAEUM_PHASE_2, "(Frontão)" },
    { TR_BUILDING_NYMPHAEUM_PHASE_2_TEXT, "Os hábeis artesãos estão trabalhando no frontão do templo, esculpindo reluzentes estátuas de mármore na imagem das ninfas aquáticas e adornando as paredes com conchas e mosaicos com temas marítimos." },
    { TR_BUILDING_ORACLE_DESC, "Este magnífico edifício é dedicado a todos os deuses, desde os mais baixos espíritos locais até o próprio Júpiter. Um local de tamanha devoção certamente garantirá à cidade o apreço do divino." },
    { TR_BUILDING_ORACLE_PHASE_1, "(Cella)" },
    { TR_BUILDING_ORACLE_PHASE_1_TEXT, "Os pedreiros estão trabalhando nas paredes e colunas da 'Cella', o interior deste oráculo, que irá abrigar as imagens sagradas." },
    {TR_BUILDING_ORACLE_PHASE_2, "(Frontão)" },
    {TR_BUILDING_ORACLE_PHASE_2_TEXT, "Os hábeis artesãos estão trabalhando no frontão do oráculo, esculpindo reluzentes estátuas de mármore na imagem dos muitos deuses que serão cultuados neste local." },
    {TR_BUILDING_SMALL_MAUSOLEUM_PHASE_1, "(Cripta)" },
    {TR_BUILDING_SMALL_MAUSOLEUM_PHASE_1_TEXT, "Os pedreiros estão erigindo os corredores de pedra habilmente esculpida para dar forma à cripta central deste mausoléu." },
    {TR_BUILDING_SMALL_MAUSOLEUM_PHASE_2, "(Frontão)" },
    {TR_BUILDING_SMALL_MAUSOLEUM_PHASE_2_TEXT, "Os hábeis artesãos estão trabalhando no frontão deste mausoléu, esculpindo reluzentes estátuas de mármore para memorializar aqueles que vierem a repousar aqui." },
    {TR_BUILDING_TAVERN_DESC_UPGRADED_WINE_AND_FOOD, "O vinho em abundância e o cheiro da carne assada nesta taberna atraem uma freguesia vibrante, em busca de música, jogatina e diversão. O desenvolvimento local permitiu que os cidadãos expandissem o edifício, com espaço adicional para receber mais clientes." },
    {TR_BUILDING_TAVERN_DESC_UPGRADED_WINE_NO_FOOD, "Enquanto o vinho continuar fluindo, esta taberna oferecerá entretenimento. O suprimento de carne aumentaria a atração. O desenvolvimento local permitiu que os cidadãos expandissem o edifício, com espaço adicional para receber mais clientes." },
    {TR_CHEAT_BUILDINGS_INVINCIBLE, "Edifícios construídos não desabam"},
    {TR_CHEAT_CASTED_CURSE, "Lançar maldição"},
    {TR_CHEAT_CLIMATE_CHANGE, "Mudança do clima ativada" },
    {TR_CHEAT_EDITOR_WARNING_TEXT, "Ativar o editor de mapas no modo cidade pode corromper o arquivo salvo ou crashar o jogo.\n\nProssiga por sua própria conta e risco e garanta que tenha um backup do arquivo salvo."},
    {TR_CHEAT_EDITOR_WARNING_TITLE, "Aviso"},
    {TR_CITY_MESSAGE_TEXT_CARAVANSERAI_COMPLETE, "O Caravançará está pronto e proporcionará novas oportunidades comerciais. Caravanas de todos os cantos do mundo conhecido já anunciaram seu interesse em vir comerciar com a nossa cidade."},
    {TR_CONFIG_DEFAULT_PLAYER_NAME, "Nome de jogador padrão:"},
    {TR_CONFIG_SHOW_DESIRABILITY_RANGE, "Mostrar atratividade quando construir um Ninfeu ou Mausoléu"},
    {TR_CONFIG_USER_PATH_CUSTOM, "Escolher diretório personalizado..."},
    {TR_CONFIG_USER_PATH_DEFAULT, "Caminho padrão (de instalação do Caesar III, sem sub-pastas)" },
    {TR_CONFIG_USER_PATH_RECOMMENDED, "Caminho recomendado ("},
    {TR_CONFIG_USER_PATH_WITH_SUBDIRECTORIES, "de instalação do Caesar III, com sub-pastas" },
    {TR_EDITOR_ALLOWED_BUILDINGS_ALLOWED, "Permitido"},
    {TR_EDITOR_ALLOWED_BUILDINGS_NOT_ALLOWED, "Não permitido"},
    {TR_EDITOR_AND, "e" },
    {TR_EDITOR_BETWEEN, "Entre" },
    {TR_EDITOR_CAESAR_SALARY, "Salário de Caesar"},
    {TR_EDITOR_CUSTOM_VARIABLES_ID, "ID"},
    {TR_EDITOR_CUSTOM_VARIABLES_IN_USE, "Variável personalizada em uso: "},
    {TR_EDITOR_CUSTOM_VARIABLES_NAME, "Nome"},
    {TR_EDITOR_CUSTOM_VARIABLES_NEW, "Nova variável personalizada"},
    {TR_EDITOR_CUSTOM_VARIABLES_VALUE, "Valor inicial"},
    {TR_EDITOR_CUSTOM_VARIABLE_UNABLE_TO_CHANGE_EVENT_ID, "ID de evento mais recente em que a variável é usada: "},
    {TR_EDITOR_CUSTOM_VARIABLE_UNABLE_TO_CHANGE_TEXT, "A variável personalizada está sendo usada por pelo menos um evento.\n\nRemova a variável personalizada do evento para mudar o nome ou para apagá-la."},
    {TR_EDITOR_CUSTOM_VARIABLE_UNABLE_TO_CHANGE_TITLE, "Não foi possível apagar a variável personalizada"},
    {TR_EDITOR_CUSTOM_VARIABLE_UNABLE_TO_SET_NAME_TEXT, "O nome está vazio ou já está sendo usado por outra variável personalizada.\n\nPor favor escolha outro nome."},
    {TR_EDITOR_CUSTOM_VARIABLE_UNABLE_TO_SET_NAME_TITLE, "Não foi possível nomear a variável personalizada"},
    {TR_EDITOR_DO_NOT_REPEAT, "Não repetir"},
    {TR_EDITOR_EDIT_DEMAND_CHANGE_INVALID_ROUTE_SET, "Rota inválida"},
    {TR_EDITOR_EDIT_DEMAND_CHANGE_NO_YEAR, "Não é possível fazer esta mudança no primeiro ano"},
    {TR_EDITOR_EDIT_INVASION_NO_SOLDIERS, "Nenhum soldado selecionado para a invasão"},
    {TR_EDITOR_EDIT_INVASION_NO_TYPE, "Tipo de inimigo não selecionado"},
    {TR_EDITOR_EDIT_INVASION_SET_YEAR, "Não é possível iniciar uma invasão no primeiro ano"},
    {TR_EDITOR_EDIT_REQUEST_NO_AMOUNT, "Quantidade não selecionada"},
    {TR_EDITOR_EDIT_REQUEST_NO_RESOURCE, "Recurso não selecionado"},
    {TR_EDITOR_EDIT_REQUEST_SET_DEADLINE, "O prazo deve ser de pelo menos um ano"},
    {TR_EDITOR_FORM_ERRORS_FOUND, "Foram encontrados erros no formulário"},
    {TR_EDITOR_FORM_HAS_FOLLOWING_ERRORS, "O formulário contém os seguintes erros:"},
    {TR_EDITOR_INVASION, "invasão"},
    {TR_EDITOR_INVASIONS, "invasões"},
    {TR_EDITOR_INVASION_ATTACK_PRIORITY, "Prioridade de ataque:"},
    {TR_EDITOR_INVASION_DATE, "Data da invasão:"},
    {TR_EDITOR_INVASION_ENEMY_TYPE, "Tipo de inimigo:"},
    {TR_EDITOR_INVASION_FROM, "De:"},
    {TR_EDITOR_INVASION_SIZE, "Tamanho da invasão:"},
    {TR_EDITOR_NEW_DEMAND_CHANGE, "Nova mudança de demanda"},
    {TR_EDITOR_NEW_INVASION, "Nova invasão"},
    {TR_EDITOR_NEW_PRICE_CHANGE, "Nova mudança de preço"},
    {TR_EDITOR_NEW_REQUEST, "Nova solicitação"},
    {TR_EDITOR_NO_DEMAND_CHANGES, "Sem mudanças de demanda"},
    {TR_EDITOR_NO_PRICE_CHANGES, "Sem mudanças de preço"},
    {TR_EDITOR_NO_ROUTES, "(Sem rotas comerciais)"},
    {TR_EDITOR_REPEAT, "Repetir:"},
    {TR_EDITOR_REPEAT_FOREVER, "Repetir indefinidamente"},
    {TR_EDITOR_REPEAT_FREQUENCY, "Frequência de repetição:"},
    {TR_EDITOR_REPEAT_FREQUENCY_MONTHS, "meses"},
    {TR_EDITOR_REPEAT_FREQUENCY_YEARS, "anos"},
    {TR_EDITOR_REPEAT_ONCE, "Repetir uma vez"},
    {TR_EDITOR_REPEAT_TEXT, "Repetir"},
    {TR_EDITOR_REPEAT_TIMES, " vezes"},
    {TR_EDITOR_REPEAT_TWICE, "Repetir duas vezes"},
    {TR_EDITOR_REQUEST, "solicitação"},
    {TR_EDITOR_REQUESTS, "solicitações"},
    {TR_EDITOR_REQUEST_AMOUNT, "Quantidade:"},
    {TR_EDITOR_REQUEST_DATE, "Data da solicitação:"},
    {TR_EDITOR_REQUEST_DEADLINE, "Prazo:"},
    {TR_EDITOR_REQUEST_FAVOR_GAINED, "Apreço recebido:"},
    {TR_EDITOR_REQUEST_RESOURCE, "Recurso:"},
    {TR_EDITOR_RETURN_TO_CITY, "Voltar para a cidade"},
    {TR_EDITOR_SCENARIO_DESELECT_VICTORY, "Remover mensagem de vitória"},
    {TR_EDITOR_SCENARIO_EVENTS_DELETE_SELECTED, "Apagar selecionado(s)"},
    {TR_EDITOR_SCENARIO_EVENTS_DELETE_SELECTED_CONFIRM_TEXT, "Tem certeza que quer apagar os itens selecionados?\n\nNão será possível reverter a ação." },
    {TR_EDITOR_SCENARIO_EVENTS_DELETE_SELECTED_CONFIRM_TITLE, "Apagar selecionado(s)?"},
    {TR_EDITOR_SCENARIO_EVENTS_GROUP, "Grupo "},
    {TR_EDITOR_SCENARIO_EVENTS_GROUPS_EXPLANATION_TOOLTIP, "Se qualquer das condições em um grupo for cumprida, o grupo inteiro é considerado cumprido.\nPara acionar o evento todos os grupos, assim como todas as condições não agrupadas, devem ser cupridas."},
    {TR_EDITOR_SCENARIO_EVENTS_NEW_GROUP, "Novo grupo"},
    {TR_EDITOR_SCENARIO_EVENTS_NO_GROUP, "Sem grupos"},
    {TR_EDITOR_SCENARIO_EVENTS_SET_TO_GROUP, "Atribuir seleção ao grupo..."},
    {TR_EDITOR_SCENARIO_EVENT_NAME, "Nome: "},
    {TR_EDITOR_SCENARIO_NO_ACTIONS, "Sem ações"},
    {TR_EDITOR_SCENARIO_NO_CONDITIONS, "Sem condições"},
    {TR_EDITOR_SCENARIO_SELECT_VICTORY, "Selecionar mensagem de vitória"},
    {TR_EDITOR_SET_A_ROUTE, "(Atribuir rota)"},
    {TR_EDITOR_UNITS, "unidades" },
    {TR_EDITOR_UNKNOWN_ROUTE, "(Rota desconhecida)"},
    {TR_FIGURE_ENEMY_CATAPULT, "Catapulta"},
    {TR_FIGURE_TYPE_ARMORY_CARTPUSHER, "Entregador do arsenal"},
    {TR_FIGURE_TYPE_BEGGAR, "Mendigo"},
    {TR_HOTKEY_SHOW_OVERLAY_EMPLOYMENT, "Visão de emprego" },
    {TR_HOTKEY_SHOW_OVERLAY_HEALTH, "Visão de saúde" },
    {TR_HOTKEY_SHOW_OVERLAY_LOGISTICS, "Visão de logística" },
    {TR_MAIN_MENU_SELECT_CAMPAIGN, "Iniciar nova campanha"},
    {TR_ORIGINAL_CAMPAIGN_FIRST_MISSION, "Tutorial 1"},
    {TR_ORIGINAL_CAMPAIGN_SECOND_MISSION, "Brundisium: Tutorial 2"},
    {TR_OVERLAY_EMPLOYMENT, "Emprego" },
    {TR_OVERLAY_HEALTH, "Global"},
    {TR_OVERLAY_LOGISTICS, "Logística" },
    {TR_PARAMETER_TYPE_CLIMATE, "Clima" },
    {TR_PARAMETER_TYPE_GOD, "Deus" },
    {TR_PARAMETER_VALUE_CLIMATE_CENTRAL, "Central" },
    {TR_PARAMETER_VALUE_CLIMATE_DESERT, "Desértico" },
    {TR_PARAMETER_VALUE_CLIMATE_NORTHERN, "Setentrional" },
    {TR_PARAMETER_VALUE_GOD_CERES, "Ceres"},
    {TR_PARAMETER_VALUE_GOD_MARS, "Marte"},
    {TR_PARAMETER_VALUE_GOD_MERCURY, "Mercúrio"},
    {TR_PARAMETER_VALUE_GOD_NEPTUNE, "Netuno"},
    {TR_PARAMETER_VALUE_GOD_VENUS, "Vênus"},
    {TR_PARAMETER_VALUE_MEDIA_TYPE_BACKGROUND_IMAGE, "Papel de parede"},
    {TR_PARAMETER_VALUE_MEDIA_TYPE_SPEECH, "Fala"},
    {TR_REPLAY_MAP_NOT_FOUND_MESSAGE, "O arquivo de mapa original para este jogo salvo não foi encontrado.\nÉ necessário o seguinte arquivo com a extensão .map ou .mapx:"},
    {TR_REPLAY_MAP_NOT_FOUND_TITLE, "Não foi possível abrir o mapa"},
    {TR_SAVE_DIALOG_FILE_DOES_NOT_EXIST_TEXT, "O arquivo selecionado não existe.\nPor favor, selecione outro arquivo."},
    {TR_SAVE_DIALOG_FILE_DOES_NOT_EXIST_TITLE, "Arquivo inexistente"},
    {TR_SELECTED, "Selecionado"},
    {TR_SELECT_ALL, "Selecionar todos"},
    {TR_SELECT_NONE, "Selecionar nenhum"},
    {TR_TOOLTIP_BARRACKS_PRIORITY_AUXARCH, "Priorizar o treinamento de arqueiros"},
    {TR_TOOLTIP_BARRACKS_PRIORITY_AUXINF, "Priorizar o treinamento de infantaria leve"},
    {TR_TOOLTIP_BARRACKS_PRIORITY_FORT, "Priorizar o treinamento de legionários"},
    {TR_TOOLTIP_BARRACKS_PRIORITY_JAVELIN, "PPriorizar o treinamento de lanceiros"},
    {TR_TOOLTIP_BARRACKS_PRIORITY_MOUNTED, "Priorizar o treinamento de cavaleiros"},
    {TR_TOOLTIP_BARRACKS_PRIORITY_TOWER, "Priorizar o treinamento de sentinelas de muralhas"},
    {TR_TOOLTIP_BARRACKS_PRIORITY_WATCHTOWER, "Priorizar o treinamento de sentinelas de atalaias"},
    {TR_TOOLTIP_BUTTON_ACCEPT_ARMOURY, "Permitir que arsenais busquem daqui"},
    {TR_TOOLTIP_BUTTON_ACCEPT_BARKEEP, "Permitir que tabernas busquem daqui"},
    {TR_TOOLTIP_BUTTON_ACCEPT_CARAVANSERAI, "Permitir que o Caravançará busque daqui"},
    {TR_TOOLTIP_BUTTON_ACCEPT_DELIVERY, "Permitir que o arsenal entregue armas aqui"},
    {TR_TOOLTIP_BUTTON_ACCEPT_LIGHTHOUSE, "Permitir que o Farol busque daqui"},
    {TR_TOOLTIP_BUTTON_ACCEPT_WORKCAMP, "Permitir que campos de trabalho busquem daqui"},
    {TR_TOOLTIP_BUTTON_CAN_GO_TO_ADVISORS, "Mostrar o conselheiro responsável por este edifício." },
    {TR_TOOLTIP_BUTTON_DELETE_COMMON_MESSAGES, "Apagar mensagens comuns"},
    {TR_TOOLTIP_BUTTON_REJECT_ARMOURY, "Não permitir que arsenais busquem daqui" },
    {TR_TOOLTIP_BUTTON_REJECT_BARKEEP, "Não permitir que tabernas busquem daqui"},
    {TR_TOOLTIP_BUTTON_REJECT_CARAVANSERAI, "Não permitir que o Caravançará busque daqui"},
    {TR_TOOLTIP_BUTTON_REJECT_DELIVERY, "Não permitir que o arsenal entregue armas aqui"},
    {TR_TOOLTIP_BUTTON_REJECT_LIGHTHOUSE, "Não permitir que o Farol busque daqui"},
    {TR_TOOLTIP_BUTTON_REJECT_MARKET_LADIES, "Não permitir que mercados busquem daqui"},
    {TR_TOOLTIP_BUTTON_REJECT_QUARTERMASTER, "Não permitir que o posto de suprimentos busque daqui"},
    {TR_TOOLTIP_BUTTON_REJECT_TRADE_CARAVAN, "Não permitir que caravanas busquem daqui"},
    {TR_TOOLTIP_BUTTON_REJECT_TRADE_SHIPS, "Não permitir que navios mercantes busquem daqui"},
    {TR_TOOLTIP_BUTTON_REJECT_WORKCAMP, "Não permitir que campos de trabalho busquem daqui"},
    {TR_TOOLTIP_BUTTON_ROADBLOCK_ORDER_ACCEPT_ALL, "Aceitar todos os andarilhos"},
    {TR_TOOLTIP_BUTTON_ROADBLOCK_ORDER_REJECT_ALL, "Recusar todos os andarilhos"},
    {TR_TOOLTIP_BUTTON_ROADBLOCK_PERMISSION, "Permissões de andarilhos" },
    {TR_TOOLTIP_BUTTON_ROADBLOCK_PERMISSION_EDUCATION, "Alterar acesso de educadores" },
    {TR_TOOLTIP_BUTTON_ROADBLOCK_PERMISSION_ENTERTAINER, "Alterar acesso de artistas" },
    {TR_TOOLTIP_BUTTON_ROADBLOCK_PERMISSION_LABOR_SEEKER, "Alterar acesso de recrutador" },
    {TR_TOOLTIP_BUTTON_ROADBLOCK_PERMISSION_MAINTENANCE, "Alterar acesso de prefeitos e engenheiros" },
    {TR_TOOLTIP_BUTTON_ROADBLOCK_PERMISSION_MARKET, "Alterar acesso de vendedora do mercado" },
    {TR_TOOLTIP_BUTTON_ROADBLOCK_PERMISSION_MEDICINE, "Alterar acesso de profissionais de saúde" },
    {TR_TOOLTIP_BUTTON_ROADBLOCK_PERMISSION_MISSIONARY, "Alterar acesso de missionários" },
    {TR_TOOLTIP_BUTTON_ROADBLOCK_PERMISSION_PRIEST, "Alterar acesso de sacerdotes" },
    {TR_TOOLTIP_BUTTON_ROADBLOCK_PERMISSION_TAX_COLLECTOR, "Alterar acesso de cobrador de impostos" },
    {TR_TOOLTIP_BUTTON_ROADBLOCK_PERMISSION_WATCHMAN, "Alterar acesso de sentinela" },
    {TR_TOOLTIP_BUTTON_STORAGE_ORDER_ACCEPT_ALL, "Aceitar todos os produtos"},
    {TR_TOOLTIP_BUTTON_STORAGE_ORDER_REJECT_ALL, "Recusar todos os produtos"},
    {TR_TOOLTIP_OVERLAY_EMPLOYMENT_FULL, "Este edifício tem todos os trabalhadores" },
    {TR_TOOLTIP_OVERLAY_EMPLOYMENT_MISSING_1, " trabalhador necessário neste edifício" },
    {TR_TOOLTIP_OVERLAY_EMPLOYMENT_MISSING_2, " trabalhadores necessários neste edifício" },
    {TR_TOOLTIP_OVERLAY_EMPLOYMENT_MOTHBALL, " trabalhadores necessários neste edifício (desligado)" },
    {TR_TOOLTIP_OVERLAY_HEALTH_0, "A saúde nesta moradia é pavorosa"},
    {TR_TOOLTIP_OVERLAY_HEALTH_1, "A saúde nesta moradia é horrível"},
    {TR_TOOLTIP_OVERLAY_HEALTH_10, "A saúde nesta moradia é perfeita"},
    {TR_TOOLTIP_OVERLAY_HEALTH_2, "A saúde nesta moradia é ruim"},
    {TR_TOOLTIP_OVERLAY_HEALTH_3, "A saúde nesta moradia é precária"},
    {TR_TOOLTIP_OVERLAY_HEALTH_4, "A saúde nesta moradia é abaixo da média"},
    {TR_TOOLTIP_OVERLAY_HEALTH_5, "A saúde nesta moradia é medíocre"},
    {TR_TOOLTIP_OVERLAY_HEALTH_6, "A saúde nesta moradia é boa"},
    {TR_TOOLTIP_OVERLAY_HEALTH_7, "A saúde nesta moradia é muito boa"},
    {TR_TOOLTIP_OVERLAY_HEALTH_8, "A saúde nesta moradia é excelente"},
    {TR_TOOLTIP_OVERLAY_HEALTH_9, "A saúde nesta moradia é quase perfeita"},
    {TR_TOOLTIP_OVERLAY_HEALTH_NONE, "Ninguém vive aqui ainda"},
    {TR_USER_DIRECTORIES_CANCELLED_TEXT, "Você decidiu não utilizar um diretório de usuário. O diretório de instalação C3 será usado.\n" },
    {TR_USER_DIRECTORIES_CANCELLED_TITLE, "Seleção de diretório cancelada"},
    {TR_USER_DIRECTORIES_NOT_SET_UP_TEXT, "Você não selecionou um diretório de usuário, onde os arquivos salvo, cenários e mapas serão armazenados.\n" },
    {TR_USER_DIRECTORIES_NOT_SET_UP_TITLE, "Diretórios personalizados não selecionados"},
    {TR_USER_DIRECTORIES_NOT_WRITEABLE_TEXT, "Não é possível escrever o diretório de usuário selecionado.\n\nPor favor, selecione um diretório de usuário diferente."},
    {TR_USER_DIRECTORIES_NOT_WRITEABLE_TEXT_DETAILED, "Não é possível escrever o diretório selecionado.\n\nNão será possível salvar os jogos.\nPor favor, selecione um diretório de usuário diferente na janela de opções do menu principal."},
    {TR_USER_DIRECTORIES_NOT_WRITEABLE_TITLE, "Diretório de usuário impossível"},
    {TR_USER_DIRECTORIES_USER_PATH_CHANGED_OVERWRITE, "Substituir arquivos existentes"},
    ...
    {TR_WINDOW_ADVISOR_MILITARY_ARCHER, "Arqueiros"},
    {TR_WINDOW_ADVISOR_MILITARY_INFANTRY, "Infantaria Leve"},
    {TR_WINDOW_ADVISOR_MOUNTED, "Cavaleiros" },
    {TR_WINDOW_ADVISOR_RELIGION_ALTARS_HEADER, "Altares"},
    {TR_WINDOW_BARRACKS_FORTS, "Fortes"},
    {TR_WINDOW_BARRACKS_PRIORITY, "Prioridade de recrutamento:"},
    {TR_WINDOW_BARRACKS_TOWERS, "Torres"},
    {TR_WINDOW_CAMPAIGN_AUTHOR, "Autor:"},
    {TR_WINDOW_CAMPAIGN_BUTTON_BEGIN_CAMPAIGN, "Iniciar campanha"},
    {TR_WINDOW_CAMPAIGN_BUTTON_MISSION_LIST, "Seleção de cenários"},
    {TR_WINDOW_CAMPAIGN_CURRENT_MISSION, "Missão atual:"},
    {TR_WINDOW_CAMPAIGN_FINISHED, "Campanha terminada"},
    {TR_WINDOW_CAMPAIGN_MISSION_FAILED_TO_LOAD_TEXT, "A missão selecionada não pode ser aberta.\nPor favor, verifique augustus-log.txt no seu diretório Augustus para mais detalhes."},
    {TR_WINDOW_CAMPAIGN_MISSION_FAILED_TO_LOAD_TITLE, "Não foi possível abrir a missão"},
    {TR_WINDOW_CAMPAIGN_NO_DESC, "Sem descrição"},
    {TR_WINDOW_INVALID_CAMPAIGN_TEXT, "O arquivo de campanha fornecido é inválido.\nPor favor, verifique augustus-log.txt no seu diretório Augustus para mais detalhes."},
    {TR_WINDOW_INVALID_CAMPAIGN_TITLE, "Arquivo de campanha inválido" },
    {TR_WINDOW_MESSAGE_LIST_SELECTED_ALL, "Todas as mensagens"},
    {TR_WINDOW_MESSAGE_LIST_SELECTED_COMMON, "Mensagens comuns" },
    {TR_WINDOW_MESSAGE_LIST_SELECTED_CUSTOM, "Mensagens personalizadas" },
    {TR_WINDOW_MISSION_LIST_BUTTON_BEGIN_SCENARIO, "Iniciar cenário" },
    {TR_WINDOW_MISSION_LIST_BUTTON_SCENARIO_SELECTION, "Seleção de cenários"},
    {TR_WINDOW_MISSION_LIST_CAMPAIGN_NOT_FINISHED, "Campanha incompleta"},
