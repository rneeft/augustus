...
static translation_string all_strings[] = {
    ...
    {TR_CONFIG_FIXED_WORKERS, "固定38%的顾工人口"},
    ...
    {TR_HOTKEY_SHOW_ADVISOR_LABOR, "顾工顾问"},
    ...
    {TR_BUILDING_GRAND_TEMPLE_CERES_MODULE_1_DESC, "神赐效果：\n- 居民食物消耗-20%"},
    {TR_BUILDING_GRAND_TEMPLE_NEPTUNE_MODULE_1_DESC, "神赐效果：\n- 可为马术场生产战车"},
    {TR_BUILDING_GRAND_TEMPLE_MERCURY_MODULE_1_DESC, "神赐效果：\n- 居民陶器和家具消耗-20%"},
    {TR_BUILDING_GRAND_TEMPLE_MARS_MODULE_1_DESC, "神赐效果：\n- 可根据自己覆盖的住宅数量生产相应数量的食物，并运送至军粮站\n   - 要塞维护费-25%"},
    {TR_BUILDING_GRAND_TEMPLE_VENUS_MODULE_1_DESC, "神赐效果：\n- 可根据服务人口生产葡萄酒，并经祭司分发至住宅和酒馆。"},
    {TR_BUILDING_GRAND_TEMPLE_CERES_MODULE_2_DESC, "神赐效果：\n- 这里的祭司能从城市储备中取货一种当地自产食物和橄榄油并分发至住宅"},
    {TR_BUILDING_GRAND_TEMPLE_NEPTUNE_MODULE_2_DESC, "神赐效果：\n- 住房容量+5%，神庙可像注满水的贮水池一样供水"},
    {TR_BUILDING_GRAND_TEMPLE_MERCURY_MODULE_2_DESC, "神赐效果：\n- 居民橄榄油和葡萄酒消耗-20%"},
    {TR_BUILDING_GRAND_TEMPLE_MARS_MODULE_2_DESC, "神赐效果：\n- 所有物资消耗-10%"},
    {TR_BUILDING_GRAND_TEMPLE_VENUS_MODULE_2_DESC, "神赐效果：\n- 这里的祭司可以美化住宅并提供娱乐，无需其他装饰即可提高周边满意度。"},
    {TR_BUILDING_PANTHEON_MODULE_1_DESC, "神赐效果：\n- 城市中所有神庙由万神殿派出祭司，传播信仰和神灵的祝福。"},
    {TR_BUILDING_PANTHEON_MODULE_2_DESC, "神赐效果：\n- 接触万神殿的住宅提升一级"},
    ...
    {TR_BUILDING_WORK_CAMP, "顾 工 营"},
    {TR_BUILDING_WORK_CAMP_DESC, "顾工在此聚集并将建材运至建筑工地。"},
    {TR_BUILDING_DEPOT, "配 送 站"},
    {TR_BUILDING_CAT_DEPOT, "配送站"},
    {TR_BUILDING_DEPOT_DESC, "配送站在仓库和谷仓之间运送物资。每次运输完成后，推车将返回配送站。"},
    ...
    {TR_BUILDING_NEPTUNE_TEMPLE_QUOTE, "随着纳普敦放下他的三叉戟，巨浪滚滚落下\n在凶涌的海面上，浪花抚平他那布满皱纹的脸\n海之信使特里同，已在他的召唤下浮出海面\n他身着提尔长袍,手持弯曲小号\n-\n-奥维德-《变形记》- 第一卷"},
    {TR_BUILDING_MERCURY_TEMPLE_QUOTE, "牛羊任你抢夺，器具棕马也可以卖个好价钱\n然而生命的呼吸若是消失，就一去不复还\n千军夺不回，万金买不还\n-\n-荷马-《伊利亚特》- 第九卷"},
    {TR_BUILDING_MARS_TEMPLE_QUOTE, "对于战神马尔斯，要修好他战损的车轮和鲁钝的武器\n让他身披鲜亮的武器冲锋上阵\n并用响亮的角声唤醒这散漫的战争\n-\n-维吉尔-《The Aeneid》- 第八卷"},
    {TR_BUILDING_VENUS_TEMPLE_QUOTE, "长着翅膀的丘比特，和他温爱的母亲维纳斯\n我是如此喜悦！\n清澈的激情触动着我！\n我的心融化了！\n-\n-奥维德-《变形记》- 第九卷"},
    {TR_BUILDING_PANTHEON_QUOTE, "天堂之门打开了：朱比特召唤众神在大厅议事\n他庄严端坐，遥远地俯视着大地、军营与战争动向\n俯看着世间的一切\n至始至终，诸神皆以尊卑列座\n-\n-维吉尔-《The Aeneid》- 第十卷"},
    ...
    {TR_SELECT_EPITHET_PROMPT_TEXT, "授予宏伟神庙名号永久投身于敬拜其神灵的某一特性，同时赋予祭司特定的神赐效果。"},
    ...
    {TR_BUILDING_CARAVANSERAI_NO_EMPLOYEES, "商队旅站没有雇员，无法获取食物。"},
    ...
    {TR_BUILDING_MONUMENT_CONSTRUCTION_DESC, "建造纪念馆需要仓库提供建材、顾工营提供劳动力、建筑师协会提供师傅。"},
    ...
    {TR_CITY_MESSAGE_TEXT_IMPERIAL_GAMES_STARTING, "随着庄严的游行开始，罗马赛事开始了。愿朱比特亲自挑选赛跑、摔跤以及其他耐力和敏捷比赛的冠军。大竞技场挤得人满为患，人们不仅盼着大赛开始，更望着按惯例分发的面包和橄榄油礼物。罗马运动会开始了！"},
    ...
    {TR_BUILDING_LARARIUM, "神   位"},
    {TR_WINDOW_BUILDING_LARARIUM_DESC, "这座小型神位供奉着拉瑞斯神：罗马人的祖先神灵。在这里可以进行小型的祭献和祈祷活动。"},
    ...
    {TR_BUILDING_LARGE_TEMPLE_PHASE_2_TEXT, "手艺高超的工匠们正在为这座神庙的外观进行修饰，雕刻出许多闪闪发光的大理石神像，用以供奉在此的众多神明。"},
    {TR_BUILDING_ORACLE_DESC, "这座宏伟的建筑供奉所有神灵，从低级的当地神灵到朱比特本人。这样一个虔诚的地方一定会为你的城市赢得神明的青睐。"},
    ...
    {TR_BUILDING_ORACLE_PHASE_2_TEXT, "手艺高超的工匠们正在为这座神庙的外观进行修饰，雕刻出许多闪闪发光的大理石神像，用以供奉在此的众多神明。"},
    {TR_BUILDING_NYMPHAEUM, "宁芙神庙"},
    {TR_BUILDING_NYMPHAEUM_DESC, "该大型神庙供奉着女神宁芙：掌管泉水、河流、海洋的小神灵。她赋予这片土地美丽和富裕，予以城市神圣的关爱。"},
    {TR_BUILDING_NYMPHAEUM_PHASE_1, "（内殿）"},
    {TR_BUILDING_NYMPHAEUM_PHASE_2, "（外饰）"},
    {TR_BUILDING_NYMPHAEUM_PHASE_1_TEXT, "石匠们正在建造这座神庙大厅内殿的墙壁和柱子，这里将供奉神圣的宁芙神像和圣水。"},
    {TR_BUILDING_NYMPHAEUM_PHASE_2_TEXT, "手艺高超的工匠们正在为这座神庙的外观进行修饰，雕刻出许多闪闪发光的大理石宁芙神像，并用海贝和雕花在墙上进行装饰。"},
    {TR_BUILDING_SMALL_MAUSOLEUM, "小型墓园"},
    {TR_BUILDING_SMALL_MAUSOLEUM_DESC, "这座墓园是城市贵族为已故先人修建的安息之地，也是许多活着的人向往的往生之地。"},
    {TR_BUILDING_SMALL_MAUSOLEUM_PHASE_1, "（拱顶）"},
    {TR_BUILDING_SMALL_MAUSOLEUM_PHASE_2, "（外饰）"},
    {TR_BUILDING_SMALL_MAUSOLEUM_PHASE_1_TEXT, "石匠们正在铺设一系列精心雕刻的石块，以建造这座墓园的中央拱顶。"},
    {TR_BUILDING_SMALL_MAUSOLEUM_PHASE_2_TEXT, "手艺高超的工匠们正在为这座墓园的外观进行修饰，雕刻出许多闪闪发光的大理石雕像，以纪念将在此安息的逝者。"},
    {TR_BUILDING_LARGE_MAUSOLEUM, "大型墓园"},
    {TR_BUILDING_LARGE_MAUSOLEUM_DESC, "这座华丽的墓园有着精心修筑的大理石围墙和雕塑，展现出贵族们的伟大功业，他们也因此获得在此安息的特权。"},
    {TR_BUILDING_LARGE_MAUSOLEUM_PHASE_1, "（拱顶）"},
    {TR_BUILDING_LARGE_MAUSOLEUM_PHASE_2, "（外饰）"},
    {TR_BUILDING_LARGE_MAUSOLEUM_PHASE_1_TEXT, "石匠们正在铺设一系列精心雕琢的石块，以建造这座墓园的中央拱顶。"},
    {TR_BUILDING_LARGE_MAUSOLEUM_PHASE_2_TEXT, "手艺高超的工匠们正在为这座墓园的外观面进行修饰，他们正在雕刻闪闪发光的大理石雕像，以纪念将在此安息的逝者。"},
    {TR_BUILDING_BOTH_MAUSOLEUM_DESC, "尽管这座墓园它对附近的房屋并无益处，但它受到众神灵的青睐。这样的埋葬场所能改善城市的卫生状况，从而提升市民的整体健康水平。"},
    ...
    {TR_WINDOW_GAMES_NO_WATER_ACCESS, "维纳斯未接触到贮水池。"},
    ...
    {TR_WINDOW_ADVISOR_RELIGION_LARARIUMS, "城市里的神位"},
    ...
    {TR_TOOLTIP_OVERLAY_PROBLEMS_NO_LABOR, "无顾工"},
    ...
    {TR_BUILDING_GOLD_MINE_NO_EMPLOYEES, "这座金矿场没有顾工，生产已停止。"},
    ...
    {TR_BUILDING_STONE_QUARRY_NO_EMPLOYEES, "这座采石场没有顾工，生产已停止"},
    ...
    {TR_BUILDING_SAND_PIT_NO_EMPLOYEES, "这座采砂场没有顾工，生产已停止"},
    ...
    {TR_BUILDING_BRICKWORKS_NO_EMPLOYEES, "这座造砖厂没有顾工，生产已停止。"},
    ...
    {TR_BUILDING_BRICKWORKS_NO_RESOURCES, "这座造砖厂需要从“黏土坑”、“采砂场”或者“仓库”运送“黏土”和“砂料”才能生产“瓷砖”。"},
    {TR_BUILDING_BRICKWORKS_STORED_SAND, "存储砂料："},
    {TR_BUILDING_BRICKWORKS_STORED_CLAY, "存储黏土："},
    {TR_BUILDING_CONCRETE_MAKER, "水 泥 厂"},
    {TR_BUILDING_CONCRETE_MAKER_DESC, "在这里，砂料被加工成水泥，用于纪念馆的建造。"},
    ...
    {TR_BUILDING_CONCRETE_MAKER_NO_EMPLOYEES, "这座水泥厂没有顾工，生产已停止。"},
    {TR_BUILDING_CONCRETE_MAKER_FULL_EMPLOYEES, "这座水泥厂顾工配备齐全，正在全力生产水泥。"},
    ...
    {TR_BUILDING_CONCRETE_MAKER_NO_RESOURCES, "生产水泥需要从水泉或水井获取水源，还需要从仓库或采砂场获取砂料。"},
    ...
    {TR_BUILDING_CITY_MINT_PHASE_2_TEXT, "工匠们正在为锻造硬币的Monteta进行最后修饰，建造储币仓库和造币工人住所。"},
    ...
    {TR_BUILDING_CITY_MINT_NO_EMPLOYEES, "城市造币厂没有顾工，生产已停止。"},
    {TR_BUILDING_CITY_MINT_FULL_EMPLOYEES, "这座城市造币厂顾工配备齐全，正在全力生产罗马币。"},
    ...
    {TR_BUILDING_DEPOT_NO_EMPLOYEES, "这个配送站没有顾工。手推车闲置在仓库中。"},
    {TR_BUILDING_DEPOT_FEW_EMPLOYEES, "这里几乎没有顾工，没人记得上次配送是在什么时候。"},
    ...
    {TR_WINDOW_ADVISOR_RELIGION_ALTARS_HEADER, "神像"},
    ...
    {TR_BUILDING_ARMOURY_NO_EMPLOYEES, "由于没有顾工，军工厂无法向我们的士兵提供武器。愿马尔斯能守护我们，因为我们的军队无法保护人民！"},
    {TR_BUILDING_ARMOURY_SOME_EMPLOYEES, "由于顾工不足，为军队提供武器装备需要很长的时间。希望我们的敌人也不赶时间。"},
    {TR_BUILDING_ARMOURY_MANY_EMPLOYEES, "这座军工厂可以为士兵提供武器装备，但顾工的短缺会导致军队供给不足。"},
    ...
    {TR_CITY_MESSAGE_TEXT_CARAVANSERAI_COMPLETE, "商队旅站已完成建设，新的商机已到来。世界各地的商队宣布他们非常渴望到这里来进行贸易。"},
    ...
    {TR_WINDOW_ADVISOR_MILITARY_ARCHER, "弓手"},
    ...
    {TR_TOOLTIP_BUTTON_ACCEPT_CARAVANSERAI, "允许商队旅站在此取得物资"},
    {TR_TOOLTIP_BUTTON_REJECT_CARAVANSERAI, "不允许商队旅站在此取得物资"},
    ...
    {TR_TOOLTIP_BUTTON_ACCEPT_WORKCAMP, "允许顾工营在此取得物资"},
    {TR_TOOLTIP_BUTTON_REJECT_WORKCAMP, "不允许顾工营在此取得物资"},
