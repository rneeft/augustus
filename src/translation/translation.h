...
typedef enum {
    ...
    TR_CONFIG_ZOOM_COULD_NOT_BE_ENABLED_TITLE,
    ...
    TR_BUILDING_FARMHOUSE,
    TR_BUILDING_WHEAT_PLOT,
    TR_BUILDING_WHEAT_PLOT_DESC,
    TR_BUILDING_WHEAT_PLOT_DESC2,
    TR_BUILDING_WHEAT_PLOT_DESC3,
    TR_FIGURE_TYPE_FARMER,
    TRANSLATION_MAX_KEY,
} translation_key;
