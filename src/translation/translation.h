...
typedef enum {
    ...
    TR_EDITOR_REPEAT_FREQUENCY_TRIGGERS,
    ...
    TR_EDITOR_SCENARIO_EVENT_TRIGGERS_UNTIL_ACTIVE,
    ...
    TR_PARAMETER_TYPE_CONTEXT_BUILDING,
    ...
    TR_PARAMETER_TYPE_EVENT_TRIGGER_TYPE,
    ...
    TR_CONDITION_TYPE_CONTEXT_BUILDING_TYPE,
    ...
    TR_PARAMETER_VALUE_EVENT_TRIGGER_MONTH_START,
    ...
    TR_PARAMETER_VALUE_EVENT_TRIGGER_BUILDING_DESTROYED_BY_ANYTHING,
    TR_PARAMETER_VALUE_EVENT_TRIGGER_BUILDING_PLACED_BY_PLAYER,
