...
typedef enum {
    ...
    TR_CONFIG_ENABLE_PAVED_ROADS_NEAR_GRANNARIES,
    TR_CONFIG_UI_ANIMATE_TRADE_ROUTES,
    TR_HOTKEY_NEXT_TRACK,
    TR_CONFIG_MOVE_LEGION_SOUND_SWAP,
    TR_OVERLAY_HOUSING,
    TR_OVERLAY_HOUSING_SMALL_TENTS,
    TR_OVERLAY_HOUSING_LARGE_TENTS,
    TR_OVERLAY_HOUSING_SMALL_SHACKS,
    TR_OVERLAY_HOUSING_LARGE_SHACKS,
    TR_OVERLAY_HOUSING_SMALL_HOVELS,
    TR_OVERLAY_HOUSING_LARGE_HOVELS,
    TR_OVERLAY_HOUSING_SMALL_CASAS,
    TR_OVERLAY_HOUSING_LARGE_CASAS,
    TR_OVERLAY_HOUSING_SMALL_INSULAE,
    TR_OVERLAY_HOUSING_MEDIUM_INSULAE,
    TR_OVERLAY_HOUSING_LARGE_INSULAE,
    TR_OVERLAY_HOUSING_GRAND_INSULAE,
    TR_OVERLAY_HOUSING_SMALL_VILLAS,
    TR_OVERLAY_HOUSING_MEDIUM_VILLAS,
    TR_OVERLAY_HOUSING_LARGE_VILLAS,
    TR_OVERLAY_HOUSING_GRAND_VILLAS,
    TR_OVERLAY_HOUSING_SMALL_PALACES,
    TR_OVERLAY_HOUSING_MEDIUM_PALACES,
    TR_OVERLAY_HOUSING_LARGE_PALACES,
    TR_OVERLAY_HOUSING_LUXURY_PALACES,
    TRANSLATION_MAX_KEY,
} translation_key;
