...
static const int ADDITIONAL_OVERLAY_TR[] = { TR_OVERLAY_ROADS, TR_OVERLAY_LEVY, TR_OVERLAY_TAVERN, TR_OVERLAY_ARENA_COL, TR_OVERLAY_SENTIMENT, TR_OVERLAY_MOTHBALL, TR_OVERLAY_ENEMY, TR_OVERLAY_LOGISTICS, TR_OVERLAY_SICKNESS, TR_OVERLAY_EFFICIENCY, TR_OVERLAY_STORAGES, TR_OVERLAY_HEALTH, TR_OVERLAY_EMPLOYMENT, TR_OVERLAY_HOUSING, TR_OVERLAY_HOUSING_SMALL_TENT, TR_OVERLAY_HOUSING_LARGE_TENT, TR_OVERLAY_HOUSING_SMALL_SHACK,
    TR_OVERLAY_HOUSING_LARGE_SHACK,
    TR_OVERLAY_HOUSING_SMALL_HOVEL,
    TR_OVERLAY_HOUSING_LARGE_HOVEL,
    TR_OVERLAY_HOUSING_SMALL_CASA,
    TR_OVERLAY_HOUSING_LARGE_CASA,
    TR_OVERLAY_HOUSING_SMALL_INSULA,
    TR_OVERLAY_HOUSING_MEDIUM_INSULA,
    TR_OVERLAY_HOUSING_LARGE_INSULA,
    TR_OVERLAY_HOUSING_GRAND_INSULA,
    TR_OVERLAY_HOUSING_SMALL_VILLA,
    TR_OVERLAY_HOUSING_MEDIUM_VILLA,
    TR_OVERLAY_HOUSING_LARGE_VILLA,
    TR_OVERLAY_HOUSING_GRAND_VILLA,
    TR_OVERLAY_HOUSING_SMALL_PALACE,
    TR_OVERLAY_HOUSING_MEDIUM_PALACE,
    TR_OVERLAY_HOUSING_LARGE_PALACE,
    TR_OVERLAY_HOUSING_LUXURY_PALACE };
